...
#define LOW_PRECISION`),e}function Bm(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===gc?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===hh?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===cn&&(e="SHADOWMAP_TYPE_VSM"),e}function km(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case yi:case Si:e="ENVMAP_TYPE_CUBE";break;case Fs:e="ENVMAP_TYPE_CUBE_UV";break}return e}function zm(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Si:e="ENVMAP_MODE_REFRACTION";break}return e}function Hm(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case _c:e="ENVMAP_BLENDING_MULTIPLY";break;case Ch:e="ENVMAP_BLENDING_MIX";break;case Ph:e="ENVMAP_BLENDING_ADD";break}return e}function Vm(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function Gm(i,e,t,n){const s=i.getContext(),r=t.defines;let o=t.vertexShader,a=t.fragmentShader;const c=Bm(t),l=km(t),u=zm(t),d=Hm(t),f=Vm(t),m=Pm(t),v=Lm(r),y=s.createProgram();let p,h,b=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(Oi).join(`
`)),o=To(o),o=Ya(o,t),o=$a(o,t),a=To(a),a=Ya(a,t),a=$a(a,t),o=Ka(o),a=Ka(a),t.isRawShaderMaterial!==!0&&(b=`#version 300 es
...
`)+`
`+h);const T=b+p+o,E=b+h+a,U=Wa(s,s.VERTEX_SHADER,T),P=Wa(s,s.FRAGMENT_SHADER,E);s.attachShader(y,U),s.attachShader(y,P),t.index0AttributeName!==void 0?s.bindAttribLocation(y,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(y,0,"position"),s.linkProgram(y);function R(C){if(i.debug.checkShaderErrors){const W=s.getProgramInfoLog(y).trim(),z=s.getShaderInfoLog(U).trim(),K=s.getShaderInfoLog(P).trim();let j=!0,q=!0;if(s.getProgramParameter(y,s.LINK_STATUS)===!1)if(j=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,y,U,P);else{const J=qa(s,U,"vertex"),V=qa(s,P,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(y,s.VALIDATE_STATUS)+`
...
}`;function rg(i,e,t){let n=new ko;const s=new je,r=new je,o=new ot,a=new Au({depthPacking:zh}),c=new wu,l={},u=t.maxTextureSize,d={[wn]:wt,[wt]:wn,[hn]:hn},f=new Rn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new je},radius:{value:4}},vertexShader:ig,fragmentShader:sg}),m=f.clone();m.defines.HORIZONTAL_PASS=1;const v=new Cn;v.setAttribute("position",new Jt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const y=new qt(v,f),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=gc;let h=this.type;this.render=function(P,R,F){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||P.length===0)return;const S=i.getRenderTarget(),x=i.getActiveCubeFace(),C=i.getActiveMipmapLevel(),W=i.state;W.setBlending(bn),W.buffers.color.setClear(1,1,1,1),W.buffers.depth.setTest(!0),W.setScissorTest(!1);const z=h!==cn&&this.type===cn,K=h===cn&&this.type!==cn;for(let j=0,q=P.length;j<q;j++){const J=P[j],V=J.shadow;if(V===void 0){console.warn("THREE.WebGLShadowMap:",J,"has no shadow.");continue}if(V.autoUpdate===!1&&V.needsUpdate===!1)continue;s.copy(V.mapSize);const re=V.getFrameExtents();if(s.multiply(re),r.copy(V.mapSize),(s.x>u||s.y>u)&&(s.x>u&&(r.x=Math.floor(u/re.x),s.x=r.x*re.x,V.mapSize.x=r.x),s.y>u&&(r.y=Math.floor(u/re.y),s.y=r.y*re.y,V.mapSize.y=r.y)),V.map===null||z===!0||K===!0){const xe=this.type!==cn?{minFilter:Yt,magFilter:Yt}:{};V.map!==null&&V.map.dispose(),V.map=new Kn(s.x,s.y,xe),V.map.texture.name=J.name+".shadowMap",V.camera.updateProjectionMatrix()}i.setRenderTarget(V.map),i.clear();const ue=V.getViewportCount();for(let xe=0;xe<ue;xe++){const Ie=V.getViewport(xe);o.set(r.x*Ie.x,r.y*Ie.y,r.x*Ie.z,r.y*Ie.w),W.viewport(o),V.updateMatrices(J,xe),n=V.getFrustum(),E(R,F,V.camera,J,this.type)}V.isPointLightShadow!==!0&&this.type===cn&&b(V,F),V.needsUpdate=!1}h=this.type,p.needsUpdate=!1,i.setRenderTarget(S,x,C)};function b(P,R){const F=e.update(y);f.defines.VSM_SAMPLES!==P.blurSamples&&(f.defines.VSM_SAMPLES=P.blurSamples,m.defines.VSM_SAMPLES=P.blurSamples,f.needsUpdate=!0,m.needsUpdate=!0),P.mapPass===null&&(P.mapPass=new Kn(s.x,s.y)),f.uniforms.shadow_pass.value=P.map.texture,f.uniforms.resolution.value=P.mapSize,f.uniforms.radius.value=P.radius,i.setRenderTarget(P.mapPass),i.clear(),i.renderBufferDirect(R,null,F,f,y,null),m.uniforms.shadow_pass.value=P.mapPass.texture,m.uniforms.resolution.value=P.mapSize,m.uniforms.radius.value=P.radius,i.setRenderTarget(P.map),i.clear(),i.renderBufferDirect(R,null,F,m,y,null)}function T(P,R,F,S){let x=null;const C=F.isPointLight===!0?P.customDistanceMaterial:P.customDepthMaterial;if(C!==void 0)x=C;else if(x=F.isPointLight===!0?c:a,i.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0){const W=x.uuid,z=R.uuid;let K=l[W];K===void 0&&(K={},l[W]=K);let j=K[z];j===void 0&&(j=x.clone(),K[z]=j,R.addEventListener("dispose",U)),x=j}if(x.visible=R.visible,x.wireframe=R.wireframe,S===cn?x.side=R.shadowSide!==null?R.shadowSide:R.side:x.side=R.shadowSide!==null?R.shadowSide:d[R.side],x.alphaMap=R.alphaMap,x.alphaTest=R.alphaTest,x.map=R.map,x.clipShadows=R.clipShadows,x.clippingPlanes=R.clippingPlanes,x.clipIntersection=R.clipIntersection,x.displacementMap=R.displacementMap,x.displacementScale=R.displacementScale,x.displacementBias=R.displacementBias,x.wireframeLinewidth=R.wireframeLinewidth,x.linewidth=R.linewidth,F.isPointLight===!0&&x.isMeshDistanceMaterial===!0){const W=i.properties.get(x);W.light=F}return x}function E(P,R,F,S,x){if(P.visible===!1)return;if(P.layers.test(R.layers)&&(P.isMesh||P.isLine||P.isPoints)&&(P.castShadow||P.receiveShadow&&x===cn)&&(!P.frustumCulled||n.intersectsObject(P))){P.modelViewMatrix.multiplyMatrices(F.matrixWorldInverse,P.matrixWorld);const z=e.update(P),K=P.material;if(Array.isArray(K)){const j=z.groups;for(let q=0,J=j.length;q<J;q++){const V=j[q],re=K[V.materialIndex];if(re&&re.visible){const ue=T(P,re,S,x);P.onBeforeShadow(i,P,R,F,z,ue,V),i.renderBufferDirect(F,null,z,ue,P,V),P.onAfterShadow(i,P,R,F,z,ue,V)}}}else if(K.visible){const j=T(P,K,S,x);P.onBeforeShadow(i,P,R,F,z,j,null),i.renderBufferDirect(F,null,z,j,P,null),P.onAfterShadow(i,P,R,F,z,j,null)}}const W=P.children;for(let z=0,K=W.length;z<K;z++)E(W[z],R,F,S,x)}function U(P){P.target.removeEventListener("dispose",U);for(const F in l){const S=l[F],x=P.target.uuid;x in S&&(S[x].dispose(),delete S[x])}}}const og={[kr]:zr,[Hr]:Wr,[Vr]:Xr,[xi]:Gr,[zr]:kr,[Wr]:Hr,[Xr]:Vr,[Gr]:xi};function ag(i,e){function t(){let L=!1;const ie=new ot;let H=null;const $=new ot(0,0,0,0);return{setMask:function(le){H!==le&&!L&&(i.colorMask(le,le,le,le),H=le)},setLocked:function(le){L=le},setClear:function(le,ce,Ce,st,xt){xt===!0&&(le*=st,ce*=st,Ce*=st),ie.set(le,ce,Ce,st),$.equals(ie)===!1&&(i.clearColor(le,ce,Ce,st),$.copy(ie))},reset:function(){L=!1,H=null,$.set(-1,0,0,0)}}}function n(){let L=!1,ie=!1,H=null,$=null,le=null;return{setReversed:function(ce){if(ie!==ce){const Ce=e.get("EXT_clip_control");ie?Ce.clipControlEXT(Ce.LOWER_LEFT_EXT,Ce.ZERO_TO_ONE_EXT):Ce.clipControlEXT(Ce.LOWER_LEFT_EXT,Ce.NEGATIVE_ONE_TO_ONE_EXT);const st=le;le=null,this.setClear(st)}ie=ce},getReversed:function(){return ie},setTest:function(ce){ce?oe(i.DEPTH_TEST):Te(i.DEPTH_TEST)},setMask:function(ce){H!==ce&&!L&&(i.depthMask(ce),H=ce)},setFunc:function(ce){if(ie&&(ce=og[ce]),$!==ce){switch(ce){case kr:i.depthFunc(i.NEVER);break;case zr:i.depthFunc(i.ALWAYS);break;case Hr:i.depthFunc(i.LESS);break;case xi:i.depthFunc(i.LEQUAL);break;case Vr:i.depthFunc(i.EQUAL);break;case Gr:i.depthFunc(i.GEQUAL);break;case Wr:i.depthFunc(i.GREATER);break;case Xr:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}$=ce}},setLocked:function(ce){L=ce},setClear:function(ce){le!==ce&&(ie&&(ce=1-ce),i.clearDepth(ce),le=ce)},reset:function(){L=!1,H=null,$=null,le=null,ie=!1}}}function s(){let L=!1,ie=null,H=null,$=null,le=null,ce=null,Ce=null,st=null,xt=null;return{setTest:function(Ze){L||(Ze?oe(i.STENCIL_TEST):Te(i.STENCIL_TEST))},setMask:function(Ze){ie!==Ze&&!L&&(i.stencilMask(Ze),ie=Ze)},setFunc:function(Ze,Bt,tn){(H!==Ze||$!==Bt||le!==tn)&&(i.stencilFunc(Ze,Bt,tn),H=Ze,$=Bt,le=tn)},setOp:function(Ze,Bt,tn){(ce!==Ze||Ce!==Bt||st!==tn)&&(i.stencilOp(Ze,Bt,tn),ce=Ze,Ce=Bt,st=tn)},setLocked:function(Ze){L=Ze},setClear:function(Ze){xt!==Ze&&(i.clearStencil(Ze),xt=Ze)},reset:function(){L=!1,ie=null,H=null,$=null,le=null,ce=null,Ce=null,st=null,xt=null}}}const r=new t,o=new n,a=new s,c=new WeakMap,l=new WeakMap;let u={},d={},f=new WeakMap,m=[],v=null,y=!1,p=null,h=null,b=null,T=null,E=null,U=null,P=null,R=new Ye(0,0,0),F=0,S=!1,x=null,C=null,W=null,z=null,K=null;const j=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let q=!1,J=0;const V=i.getParameter(i.VERSION);V.indexOf("WebGL")!==-1?(J=parseFloat(/^WebGL (\d)/.exec(V)[1]),q=J>=1):V.indexOf("OpenGL ES")!==-1&&(J=parseFloat(/^OpenGL ES (\d)/.exec(V)[1]),q=J>=2);let re=null,ue={};const xe=i.getParameter(i.SCISSOR_BOX),Ie=i.getParameter(i.VIEWPORT),Qe=new ot().fromArray(xe),X=new ot().fromArray(Ie);function te(L,ie,H,$){const le=new Uint8Array(4),ce=i.createTexture();i.bindTexture(L,ce),i.texParameteri(L,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(L,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Ce=0;Ce<H;Ce++)L===i.TEXTURE_3D||L===i.TEXTURE_2D_ARRAY?i.texImage3D(ie,0,i.RGBA,1,1,$,0,i.RGBA,i.UNSIGNED_BYTE,le):i.texImage2D(ie+Ce,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,le);return ce}const ge={};ge[i.TEXTURE_2D]=te(i.TEXTURE_2D,i.TEXTURE_2D,1),ge[i.TEXTURE_CUBE_MAP]=te(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),ge[i.TEXTURE_2D_ARRAY]=te(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),ge[i.TEXTURE_3D]=te(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),o.setClear(1),a.setClear(0),oe(i.DEPTH_TEST),o.setFunc(xi),Oe(!1),Be(na),oe(i.CULL_FACE),A(bn);function oe(L){u[L]!==!0&&(i.enable(L),u[L]=!0)}function Te(L){u[L]!==!1&&(i.disable(L),u[L]=!1)}function we(L,ie){return d[L]!==ie?(i.bindFramebuffer(L,ie),d[L]=ie,L===i.DRAW_FRAMEBUFFER&&(d[i.FRAMEBUFFER]=ie),L===i.FRAMEBUFFER&&(d[i.DRAW_FRAMEBUFFER]=ie),!0):!1}function Ue(L,ie){let H=m,$=!1;if(L){H=f.get(ie),H===void 0&&(H=[],f.set(ie,H));const le=L.textures;if(H.length!==le.length||H[0]!==i.COLOR_ATTACHMENT0){for(let ce=0,Ce=le.length;ce<Ce;ce++)H[ce]=i.COLOR_ATTACHMENT0+ce;H.length=le.length,$=!0}}else H[0]!==i.BACK&&(H[0]=i.BACK,$=!0);$&&i.drawBuffers(H)}function it(L){return v!==L?(i.useProgram(L),v=L,!0):!1}const He={[Wn]:i.FUNC_ADD,[dh]:i.FUNC_SUBTRACT,[fh]:i.FUNC_REVERSE_SUBTRACT};He[ph]=i.MIN,He[mh]=i.MAX;const ct={[gh]:i.ZERO,[_h]:i.ONE,[vh]:i.SRC_COLOR,[Or]:i.SRC_ALPHA,[Th]:i.SRC_ALPHA_SATURATE,[Mh]:i.DST_COLOR,[yh]:i.DST_ALPHA,[xh]:i.ONE_MINUS_SRC_COLOR,[Br]:i.ONE_MINUS_SRC_ALPHA,[Eh]:i.ONE_MINUS_DST_COLOR,[Sh]:i.ONE_MINUS_DST_ALPHA,[bh]:i.CONSTANT_COLOR,[Ah]:i.ONE_MINUS_CONSTANT_COLOR,[wh]:i.CONSTANT_ALPHA,[Rh]:i.ONE_MINUS_CONSTANT_ALPHA};function A(L,ie,H,$,le,ce,Ce,st,xt,Ze){if(L===bn){y===!0&&(Te(i.BLEND),y=!1);return}if(y===!1&&(oe(i.BLEND),y=!0),L!==uh){if(L!==p||Ze!==S){if((h!==Wn||E!==Wn)&&(i.blendEquation(i.FUNC_ADD),h=Wn,E=Wn),Ze)switch(L){case gi:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ia:i.blendFunc(i.ONE,i.ONE);break;case sa:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case ra:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}else switch(L){case gi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ia:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case sa:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case ra:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}b=null,T=null,U=null,P=null,R.set(0,0,0),F=0,p=L,S=Ze}return}le=le||ie,ce=ce||H,Ce=Ce||$,(ie!==h||le!==E)&&(i.blendEquationSeparate(He[ie],He[le]),h=ie,E=le),(H!==b||$!==T||ce!==U||Ce!==P)&&(i.blendFuncSeparate(ct[H],ct[$],ct[ce],ct[Ce]),b=H,T=$,U=ce,P=Ce),(st.equals(R)===!1||xt!==F)&&(i.blendColor(st.r,st.g,st.b,xt),R.copy(st),F=xt),p=L,S=!1}function Dt(L,ie){L.side===hn?Te(i.CULL_FACE):oe(i.CULL_FACE);let H=L.side===wt;ie&&(H=!H),Oe(H),L.blending===gi&&L.transparent===!1?A(bn):A(L.blending,L.blendEquation,L.blendSrc,L.blendDst,L.blendEquationAlpha,L.blendSrcAlpha,L.blendDstAlpha,L.blendColor,L.blendAlpha,L.premultipliedAlpha),o.setFunc(L.depthFunc),o.setTest(L.depthTest),o.setMask(L.depthWrite),r.setMask(L.colorWrite);const $=L.stencilWrite;a.setTest($),$&&(a.setMask(L.stencilWriteMask),a.setFunc(L.stencilFunc,L.stencilRef,L.stencilFuncMask),a.setOp(L.stencilFail,L.stencilZFail,L.stencilZPass)),tt(L.polygonOffset,L.polygonOffsetFactor,L.polygonOffsetUnits),L.alphaToCoverage===!0?oe(i.SAMPLE_ALPHA_TO_COVERAGE):Te(i.SAMPLE_ALPHA_TO_COVERAGE)}function Oe(L){x!==L&&(L?i.frontFace(i.CW):i.frontFace(i.CCW),x=L)}function Be(L){L!==ch?(oe(i.CULL_FACE),L!==C&&(L===na?i.cullFace(i.BACK):L===lh?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):Te(i.CULL_FACE),C=L}function ye(L){L!==W&&(q&&i.lineWidth(L),W=L)}function tt(L,ie,H){L?(oe(i.POLYGON_OFFSET_FILL),(z!==ie||K!==H)&&(i.polygonOffset(ie,H),z=ie,K=H)):Te(i.POLYGON_OFFSET_FILL)}function ve(L){L?oe(i.SCISSOR_TEST):Te(i.SCISSOR_TEST)}function M(L){L===void 0&&(L=i.TEXTURE0+j-1),re!==L&&(i.activeTexture(L),re=L)}function g(L,ie,H){H===void 0&&(re===null?H=i.TEXTURE0+j-1:H=re);let $=ue[H];$===void 0&&($={type:void 0,texture:void 0},ue[H]=$),($.type!==L||$.texture!==ie)&&(re!==H&&(i.activeTexture(H),re=H),i.bindTexture(L,ie||ge[L]),$.type=L,$.texture=ie)}function O(){const L=ue[re];L!==void 0&&L.type!==void 0&&(i.bindTexture(L.type,null),L.type=void 0,L.texture=void 0)}function Y(){try{i.compressedTexImage2D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Z(){try{i.compressedTexImage3D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function G(){try{i.texSubImage2D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function _e(){try{i.texSubImage3D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function ae(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function de(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Ve(){try{i.texStorage2D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function ee(){try{i.texStorage3D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function fe(){try{i.texImage2D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Ee(){try{i.texImage3D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function be(L){Qe.equals(L)===!1&&(i.scissor(L.x,L.y,L.z,L.w),Qe.copy(L))}function pe(L){X.equals(L)===!1&&(i.viewport(L.x,L.y,L.z,L.w),X.copy(L))}function ke(L,ie){let H=l.get(ie);H===void 0&&(H=new WeakMap,l.set(ie,H));let $=H.get(L);$===void 0&&($=i.getUniformBlockIndex(ie,L.name),H.set(L,$))}function Le(L,ie){const $=l.get(ie).get(L);c.get(ie)!==$&&(i.uniformBlockBinding(ie,$,L.__bindingPointIndex),c.set(ie,$))}function et(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),o.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),u={},re=null,ue={},d={},f=new WeakMap,m=[],v=null,y=!1,p=null,h=null,b=null,T=null,E=null,U=null,P=null,R=new Ye(0,0,0),F=0,S=!1,x=null,C=null,W=null,z=null,K=null,Qe.set(0,0,i.canvas.width,i.canvas.height),X.set(0,0,i.canvas.width,i.canvas.height),r.reset(),o.reset(),a.reset()}return{buffers:{color:r,depth:o,stencil:a},enable:oe,disable:Te,bindFramebuffer:we,drawBuffers:Ue,useProgram:it,setBlending:A,setMaterial:Dt,setFlipSided:Oe,setCullFace:Be,setLineWidth:ye,setPolygonOffset:tt,setScissorTest:ve,activeTexture:M,bindTexture:g,unbindTexture:O,compressedTexImage2D:Y,compressedTexImage3D:Z,texImage2D:fe,texImage3D:Ee,updateUBOMapping:ke,uniformBlockBinding:Le,texStorage2D:Ve,texStorage3D:ee,texSubImage2D:G,texSubImage3D:_e,compressedTexSubImage2D:ae,compressedTexSubImage3D:de,scissor:be,viewport:pe,reset:et}}function cg(i,e,t,n,s,r,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new je,u=new WeakMap;let d;const f=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function v(M,g){return m?new OffscreenCanvas(M,g):Ds("canvas")}function y(M,g,O){let Y=1;const Z=ve(M);if((Z.width>O||Z.height>O)&&(Y=O/Math.max(Z.width,Z.height)),Y<1)if(typeof HTMLImageElement<"u"&&M instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&M instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&M instanceof ImageBitmap||typeof VideoFrame<"u"&&M instanceof VideoFrame){const G=Math.floor(Y*Z.width),_e=Math.floor(Y*Z.height);d===void 0&&(d=v(G,_e));const ae=g?v(G,_e):d;return ae.width=G,ae.height=_e,ae.getContext("2d").drawImage(M,0,0,G,_e),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+Z.width+"x"+Z.height+") to ("+G+"x"+_e+")."),ae}else return"data"in M&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+Z.width+"x"+Z.height+")."),M;return M}function p(M){return M.generateMipmaps}function h(M){i.generateMipmap(M)}function b(M){return M.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:M.isWebGL3DRenderTarget?i.TEXTURE_3D:M.isWebGLArrayRenderTarget||M.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function T(M,g,O,Y,Z=!1){if(M!==null){if(i[M]!==void 0)return i[M];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+M+"'")}let G=g;if(g===i.RED&&(O===i.FLOAT&&(G=i.R32F),O===i.HALF_FLOAT&&(G=i.R16F),O===i.UNSIGNED_BYTE&&(G=i.R8)),g===i.RED_INTEGER&&(O===i.UNSIGNED_BYTE&&(G=i.R8UI),O===i.UNSIGNED_SHORT&&(G=i.R16UI),O===i.UNSIGNED_INT&&(G=i.R32UI),O===i.BYTE&&(G=i.R8I),O===i.SHORT&&(G=i.R16I),O===i.INT&&(G=i.R32I)),g===i.RG&&(O===i.FLOAT&&(G=i.RG32F),O===i.HALF_FLOAT&&(G=i.RG16F),O===i.UNSIGNED_BYTE&&(G=i.RG8)),g===i.RG_INTEGER&&(O===i.UNSIGNED_BYTE&&(G=i.RG8UI),O===i.UNSIGNED_SHORT&&(G=i.RG16UI),O===i.UNSIGNED_INT&&(G=i.RG32UI),O===i.BYTE&&(G=i.RG8I),O===i.SHORT&&(G=i.RG16I),O===i.INT&&(G=i.RG32I)),g===i.RGB_INTEGER&&(O===i.UNSIGNED_BYTE&&(G=i.RGB8UI),O===i.UNSIGNED_SHORT&&(G=i.RGB16UI),O===i.UNSIGNED_INT&&(G=i.RGB32UI),O===i.BYTE&&(G=i.RGB8I),O===i.SHORT&&(G=i.RGB16I),O===i.INT&&(G=i.RGB32I)),g===i.RGBA_INTEGER&&(O===i.UNSIGNED_BYTE&&(G=i.RGBA8UI),O===i.UNSIGNED_SHORT&&(G=i.RGBA16UI),O===i.UNSIGNED_INT&&(G=i.RGBA32UI),O===i.BYTE&&(G=i.RGBA8I),O===i.SHORT&&(G=i.RGBA16I),O===i.INT&&(G=i.RGBA32I)),g===i.RGB&&O===i.UNSIGNED_INT_5_9_9_9_REV&&(G=i.RGB9_E5),g===i.RGBA){const _e=Z?Ps:qe.getTransfer(Y);O===i.FLOAT&&(G=i.RGBA32F),O===i.HALF_FLOAT&&(G=i.RGBA16F),O===i.UNSIGNED_BYTE&&(G=_e===Je?i.SRGB8_ALPHA8:i.RGBA8),O===i.UNSIGNED_SHORT_4_4_4_4&&(G=i.RGBA4),O===i.UNSIGNED_SHORT_5_5_5_1&&(G=i.RGB5_A1)}return(G===i.R16F||G===i.R32F||G===i.RG16F||G===i.RG32F||G===i.RGBA16F||G===i.RGBA32F)&&e.get("EXT_color_buffer_float"),G}function E(M,g){let O;return M?g===null||g===$n||g===Mi?O=i.DEPTH24_STENCIL8:g===dn?O=i.DEPTH32F_STENCIL8:g===ki&&(O=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):g===null||g===$n||g===Mi?O=i.DEPTH_COMPONENT24:g===dn?O=i.DEPTH_COMPONENT32F:g===ki&&(O=i.DEPTH_COMPONENT16),O}function U(M,g){return p(M)===!0||M.isFramebufferTexture&&M.minFilter!==Yt&&M.minFilter!==jt?Math.log2(Math.max(g.width,g.height))+1:M.mipmaps!==void 0&&M.mipmaps.length>0?M.mipmaps.length:M.isCompressedTexture&&Array.isArray(M.image)?g.mipmaps.length:1}function P(M){const g=M.target;g.removeEventListener("dispose",P),F(g),g.isVideoTexture&&u.delete(g)}function R(M){const g=M.target;g.removeEventListener("dispose",R),x(g)}function F(M){const g=n.get(M);if(g.__webglInit===void 0)return;const O=M.source,Y=f.get(O);if(Y){const Z=Y[g.__cacheKey];Z.usedTimes--,Z.usedTimes===0&&S(M),Object.keys(Y).length===0&&f.delete(O)}n.remove(M)}function S(M){const g=n.get(M);i.deleteTexture(g.__webglTexture);const O=M.source,Y=f.get(O);delete Y[g.__cacheKey],o.memory.textures--}function x(M){const g=n.get(M);if(M.depthTexture&&(M.depthTexture.dispose(),n.remove(M.depthTexture)),M.isWebGLCubeRenderTarget)for(let Y=0;Y<6;Y++){if(Array.isArray(g.__webglFramebuffer[Y]))for(let Z=0;Z<g.__webglFramebuffer[Y].length;Z++)i.deleteFramebuffer(g.__webglFramebuffer[Y][Z]);else i.deleteFramebuffer(g.__webglFramebuffer[Y]);g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer[Y])}else{if(Array.isArray(g.__webglFramebuffer))for(let Y=0;Y<g.__webglFramebuffer.length;Y++)i.deleteFramebuffer(g.__webglFramebuffer[Y]);else i.deleteFramebuffer(g.__webglFramebuffer);if(g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer),g.__webglMultisampledFramebuffer&&i.deleteFramebuffer(g.__webglMultisampledFramebuffer),g.__webglColorRenderbuffer)for(let Y=0;Y<g.__webglColorRenderbuffer.length;Y++)g.__webglColorRenderbuffer[Y]&&i.deleteRenderbuffer(g.__webglColorRenderbuffer[Y]);g.__webglDepthRenderbuffer&&i.deleteRenderbuffer(g.__webglDepthRenderbuffer)}const O=M.textures;for(let Y=0,Z=O.length;Y<Z;Y++){const G=n.get(O[Y]);G.__webglTexture&&(i.deleteTexture(G.__webglTexture),o.memory.textures--),n.remove(O[Y])}n.remove(M)}let C=0;function W(){C=0}function z(){const M=C;return M>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+M+" texture units while this GPU supports only "+s.maxTextures),C+=1,M}function K(M){const g=[];return g.push(M.wrapS),g.push(M.wrapT),g.push(M.wrapR||0),g.push(M.magFilter),g.push(M.minFilter),g.push(M.anisotropy),g.push(M.internalFormat),g.push(M.format),g.push(M.type),g.push(M.generateMipmaps),g.push(M.premultiplyAlpha),g.push(M.flipY),g.push(M.unpackAlignment),g.push(M.colorSpace),g.join()}function j(M,g){const O=n.get(M);if(M.isVideoTexture&&ye(M),M.isRenderTargetTexture===!1&&M.version>0&&O.__version!==M.version){const Y=M.image;if(Y===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Y.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{X(O,M,g);return}}t.bindTexture(i.TEXTURE_2D,O.__webglTexture,i.TEXTURE0+g)}function q(M,g){const O=n.get(M);if(M.version>0&&O.__version!==M.version){X(O,M,g);return}t.bindTexture(i.TEXTURE_2D_ARRAY,O.__webglTexture,i.TEXTURE0+g)}function J(M,g){const O=n.get(M);if(M.version>0&&O.__version!==M.version){X(O,M,g);return}t.bindTexture(i.TEXTURE_3D,O.__webglTexture,i.TEXTURE0+g)}function V(M,g){const O=n.get(M);if(M.version>0&&O.__version!==M.version){te(O,M,g);return}t.bindTexture(i.TEXTURE_CUBE_MAP,O.__webglTexture,i.TEXTURE0+g)}const re={[$r]:i.REPEAT,[qn]:i.CLAMP_TO_EDGE,[Kr]:i.MIRRORED_REPEAT},ue={[Yt]:i.NEAREST,[Bh]:i.NEAREST_MIPMAP_NEAREST,[ji]:i.NEAREST_MIPMAP_LINEAR,[jt]:i.LINEAR,[Xs]:i.LINEAR_MIPMAP_NEAREST,[Yn]:i.LINEAR_MIPMAP_LINEAR},xe={[Vh]:i.NEVER,[$h]:i.ALWAYS,[Gh]:i.LESS,[Pc]:i.LEQUAL,[Wh]:i.EQUAL,[Yh]:i.GEQUAL,[Xh]:i.GREATER,[qh]:i.NOTEQUAL};function Ie(M,g){if(g.type===dn&&e.has("OES_texture_float_linear")===!1&&(g.magFilter===jt||g.magFilter===Xs||g.magFilter===ji||g.magFilter===Yn||g.minFilter===jt||g.minFilter===Xs||g.minFilter===ji||g.minFilter===Yn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(M,i.TEXTURE_WRAP_S,re[g.wrapS]),i.texParameteri(M,i.TEXTURE_WRAP_T,re[g.wrapT]),(M===i.TEXTURE_3D||M===i.TEXTURE_2D_ARRAY)&&i.texParameteri(M,i.TEXTURE_WRAP_R,re[g.wrapR]),i.texParameteri(M,i.TEXTURE_MAG_FILTER,ue[g.magFilter]),i.texParameteri(M,i.TEXTURE_MIN_FILTER,ue[g.minFilter]),g.compareFunction&&(i.texParameteri(M,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(M,i.TEXTURE_COMPARE_FUNC,xe[g.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(g.magFilter===Yt||g.minFilter!==ji&&g.minFilter!==Yn||g.type===dn&&e.has("OES_texture_float_linear")===!1)return;if(g.anisotropy>1||n.get(g).__currentAnisotropy){const O=e.get("EXT_texture_filter_anisotropic");i.texParameterf(M,O.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,s.getMaxAnisotropy())),n.get(g).__currentAnisotropy=g.anisotropy}}}function Qe(M,g){let O=!1;M.__webglInit===void 0&&(M.__webglInit=!0,g.addEventListener("dispose",P));const Y=g.source;let Z=f.get(Y);Z===void 0&&(Z={},f.set(Y,Z));const G=K(g);if(G!==M.__cacheKey){Z[G]===void 0&&(Z[G]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,O=!0),Z[G].usedTimes++;const _e=Z[M.__cacheKey];_e!==void 0&&(Z[M.__cacheKey].usedTimes--,_e.usedTimes===0&&S(g)),M.__cacheKey=G,M.__webglTexture=Z[G].texture}return O}function X(M,g,O){let Y=i.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(Y=i.TEXTURE_2D_ARRAY),g.isData3DTexture&&(Y=i.TEXTURE_3D);const Z=Qe(M,g),G=g.source;t.bindTexture(Y,M.__webglTexture,i.TEXTURE0+O);const _e=n.get(G);if(G.version!==_e.__version||Z===!0){t.activeTexture(i.TEXTURE0+O);const ae=qe.getPrimaries(qe.workingColorSpace),de=g.colorSpace===Mn?null:qe.getPrimaries(g.colorSpace),Ve=g.colorSpace===Mn||ae===de?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ve);let ee=y(g.image,!1,s.maxTextureSize);ee=tt(g,ee);const fe=r.convert(g.format,g.colorSpace),Ee=r.convert(g.type);let be=T(g.internalFormat,fe,Ee,g.colorSpace,g.isVideoTexture);Ie(Y,g);let pe;const ke=g.mipmaps,Le=g.isVideoTexture!==!0,et=_e.__version===void 0||Z===!0,L=G.dataReady,ie=U(g,ee);if(g.isDepthTexture)be=E(g.format===Ei,g.type),et&&(Le?t.texStorage2D(i.TEXTURE_2D,1,be,ee.width,ee.height):t.texImage2D(i.TEXTURE_2D,0,be,ee.width,ee.height,0,fe,Ee,null));else if(g.isDataTexture)if(ke.length>0){Le&&et&&t.texStorage2D(i.TEXTURE_2D,ie,be,ke[0].width,ke[0].height);for(let H=0,$=ke.length;H<$;H++)pe=ke[H],Le?L&&t.texSubImage2D(i.TEXTURE_2D,H,0,0,pe.width,pe.height,fe,Ee,pe.data):t.texImage2D(i.TEXTURE_2D,H,be,pe.width,pe.height,0,fe,Ee,pe.data);g.generateMipmaps=!1}else Le?(et&&t.texStorage2D(i.TEXTURE_2D,ie,be,ee.width,ee.height),L&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,ee.width,ee.height,fe,Ee,ee.data)):t.texImage2D(i.TEXTURE_2D,0,be,ee.width,ee.height,0,fe,Ee,ee.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){Le&&et&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ie,be,ke[0].width,ke[0].height,ee.depth);for(let H=0,$=ke.length;H<$;H++)if(pe=ke[H],g.format!==Xt)if(fe!==null)if(Le){if(L)if(g.layerUpdates.size>0){const le=Ca(pe.width,pe.height,g.format,g.type);for(const ce of g.layerUpdates){const Ce=pe.data.subarray(ce*le/pe.data.BYTES_PER_ELEMENT,(ce+1)*le/pe.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,H,0,0,ce,pe.width,pe.height,1,fe,Ce)}g.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,H,0,0,0,pe.width,pe.height,ee.depth,fe,pe.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,H,be,pe.width,pe.height,ee.depth,0,pe.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Le?L&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,H,0,0,0,pe.width,pe.height,ee.depth,fe,Ee,pe.data):t.texImage3D(i.TEXTURE_2D_ARRAY,H,be,pe.width,pe.height,ee.depth,0,fe,Ee,pe.data)}else{Le&&et&&t.texStorage2D(i.TEXTURE_2D,ie,be,ke[0].width,ke[0].height);for(let H=0,$=ke.length;H<$;H++)pe=ke[H],g.format!==Xt?fe!==null?Le?L&&t.compressedTexSubImage2D(i.TEXTURE_2D,H,0,0,pe.width,pe.height,fe,pe.data):t.compressedTexImage2D(i.TEXTURE_2D,H,be,pe.width,pe.height,0,pe.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Le?L&&t.texSubImage2D(i.TEXTURE_2D,H,0,0,pe.width,pe.height,fe,Ee,pe.data):t.texImage2D(i.TEXTURE_2D,H,be,pe.width,pe.height,0,fe,Ee,pe.data)}else if(g.isDataArrayTexture)if(Le){if(et&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ie,be,ee.width,ee.height,ee.depth),L)if(g.layerUpdates.size>0){const H=Ca(ee.width,ee.height,g.format,g.type);for(const $ of g.layerUpdates){const le=ee.data.subarray($*H/ee.data.BYTES_PER_ELEMENT,($+1)*H/ee.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,$,ee.width,ee.height,1,fe,Ee,le)}g.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,ee.width,ee.height,ee.depth,fe,Ee,ee.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,be,ee.width,ee.height,ee.depth,0,fe,Ee,ee.data);else if(g.isData3DTexture)Le?(et&&t.texStorage3D(i.TEXTURE_3D,ie,be,ee.width,ee.height,ee.depth),L&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,ee.width,ee.height,ee.depth,fe,Ee,ee.data)):t.texImage3D(i.TEXTURE_3D,0,be,ee.width,ee.height,ee.depth,0,fe,Ee,ee.data);else if(g.isFramebufferTexture){if(et)if(Le)t.texStorage2D(i.TEXTURE_2D,ie,be,ee.width,ee.height);else{let H=ee.width,$=ee.height;for(let le=0;le<ie;le++)t.texImage2D(i.TEXTURE_2D,le,be,H,$,0,fe,Ee,null),H>>=1,$>>=1}}else if(ke.length>0){if(Le&&et){const H=ve(ke[0]);t.texStorage2D(i.TEXTURE_2D,ie,be,H.width,H.height)}for(let H=0,$=ke.length;H<$;H++)pe=ke[H],Le?L&&t.texSubImage2D(i.TEXTURE_2D,H,0,0,fe,Ee,pe):t.texImage2D(i.TEXTURE_2D,H,be,fe,Ee,pe);g.generateMipmaps=!1}else if(Le){if(et){const H=ve(ee);t.texStorage2D(i.TEXTURE_2D,ie,be,H.width,H.height)}L&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,fe,Ee,ee)}else t.texImage2D(i.TEXTURE_2D,0,be,fe,Ee,ee);p(g)&&h(Y),_e.__version=G.version,g.onUpdate&&g.onUpdate(g)}M.__version=g.version}function te(M,g,O){if(g.image.length!==6)return;const Y=Qe(M,g),Z=g.source;t.bindTexture(i.TEXTURE_CUBE_MAP,M.__webglTexture,i.TEXTURE0+O);const G=n.get(Z);if(Z.version!==G.__version||Y===!0){t.activeTexture(i.TEXTURE0+O);const _e=qe.getPrimaries(qe.workingColorSpace),ae=g.colorSpace===Mn?null:qe.getPrimaries(g.colorSpace),de=g.colorSpace===Mn||_e===ae?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,de);const Ve=g.isCompressedTexture||g.image[0].isCompressedTexture,ee=g.image[0]&&g.image[0].isDataTexture,fe=[];for(let $=0;$<6;$++)!Ve&&!ee?fe[$]=y(g.image[$],!0,s.maxCubemapSize):fe[$]=ee?g.image[$].image:g.image[$],fe[$]=tt(g,fe[$]);const Ee=fe[0],be=r.convert(g.format,g.colorSpace),pe=r.convert(g.type),ke=T(g.internalFormat,be,pe,g.colorSpace),Le=g.isVideoTexture!==!0,et=G.__version===void 0||Y===!0,L=Z.dataReady;let ie=U(g,Ee);Ie(i.TEXTURE_CUBE_MAP,g);let H;if(Ve){Le&&et&&t.texStorage2D(i.TEXTURE_CUBE_MAP,ie,ke,Ee.width,Ee.height);for(let $=0;$<6;$++){H=fe[$].mipmaps;for(let le=0;le<H.length;le++){const ce=H[le];g.format!==Xt?be!==null?Le?L&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,le,0,0,ce.width,ce.height,be,ce.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,le,ke,ce.width,ce.height,0,ce.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Le?L&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,le,0,0,ce.width,ce.height,be,pe,ce.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,le,ke,ce.width,ce.height,0,be,pe,ce.data)}}}else{if(H=g.mipmaps,Le&&et){H.length>0&&ie++;const $=ve(fe[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,ie,ke,$.width,$.height)}for(let $=0;$<6;$++)if(ee){Le?L&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,0,0,fe[$].width,fe[$].height,be,pe,fe[$].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,ke,fe[$].width,fe[$].height,0,be,pe,fe[$].data);for(let le=0;le<H.length;le++){const Ce=H[le].image[$].image;Le?L&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,le+1,0,0,Ce.width,Ce.height,be,pe,Ce.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,le+1,ke,Ce.width,Ce.height,0,be,pe,Ce.data)}}else{Le?L&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,0,0,be,pe,fe[$]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,ke,be,pe,fe[$]);for(let le=0;le<H.length;le++){const ce=H[le];Le?L&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,le+1,0,0,be,pe,ce.image[$]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,le+1,ke,be,pe,ce.image[$])}}}p(g)&&h(i.TEXTURE_CUBE_MAP),G.__version=Z.version,g.onUpdate&&g.onUpdate(g)}M.__version=g.version}function ge(M,g,O,Y,Z,G){const _e=r.convert(O.format,O.colorSpace),ae=r.convert(O.type),de=T(O.internalFormat,_e,ae,O.colorSpace),Ve=n.get(g),ee=n.get(O);if(ee.__renderTarget=g,!Ve.__hasExternalTextures){const fe=Math.max(1,g.width>>G),Ee=Math.max(1,g.height>>G);Z===i.TEXTURE_3D||Z===i.TEXTURE_2D_ARRAY?t.texImage3D(Z,G,de,fe,Ee,g.depth,0,_e,ae,null):t.texImage2D(Z,G,de,fe,Ee,0,_e,ae,null)}t.bindFramebuffer(i.FRAMEBUFFER,M),Be(g)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Y,Z,ee.__webglTexture,0,Oe(g)):(Z===i.TEXTURE_2D||Z>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&Z<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,Y,Z,ee.__webglTexture,G),t.bindFramebuffer(i.FRAMEBUFFER,null)}function oe(M,g,O){if(i.bindRenderbuffer(i.RENDERBUFFER,M),g.depthBuffer){const Y=g.depthTexture,Z=Y&&Y.isDepthTexture?Y.type:null,G=E(g.stencilBuffer,Z),_e=g.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ae=Oe(g);Be(g)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,ae,G,g.width,g.height):O?i.renderbufferStorageMultisample(i.RENDERBUFFER,ae,G,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,G,g.width,g.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,_e,i.RENDERBUFFER,M)}else{const Y=g.textures;for(let Z=0;Z<Y.length;Z++){const G=Y[Z],_e=r.convert(G.format,G.colorSpace),ae=r.convert(G.type),de=T(G.internalFormat,_e,ae,G.colorSpace),Ve=Oe(g);O&&Be(g)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Ve,de,g.width,g.height):Be(g)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Ve,de,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,de,g.width,g.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Te(M,g){if(g&&g.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,M),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const Y=n.get(g.depthTexture);Y.__renderTarget=g,(!Y.__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),j(g.depthTexture,0);const Z=Y.__webglTexture,G=Oe(g);if(g.depthTexture.format===_i)Be(g)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,Z,0,G):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,Z,0);else if(g.depthTexture.format===Ei)Be(g)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,Z,0,G):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,Z,0);else throw new Error("Unknown depthTexture format")}function we(M){const g=n.get(M),O=M.isWebGLCubeRenderTarget===!0;if(g.__boundDepthTexture!==M.depthTexture){const Y=M.depthTexture;if(g.__depthDisposeCallback&&g.__depthDisposeCallback(),Y){const Z=()=>{delete g.__boundDepthTexture,delete g.__depthDisposeCallback,Y.removeEventListener("dispose",Z)};Y.addEventListener("dispose",Z),g.__depthDisposeCallback=Z}g.__boundDepthTexture=Y}if(M.depthTexture&&!g.__autoAllocateDepthBuffer){if(O)throw new Error("target.depthTexture not supported in Cube render targets");Te(g.__webglFramebuffer,M)}else if(O){g.__webglDepthbuffer=[];for(let Y=0;Y<6;Y++)if(t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[Y]),g.__webglDepthbuffer[Y]===void 0)g.__webglDepthbuffer[Y]=i.createRenderbuffer(),oe(g.__webglDepthbuffer[Y],M,!1);else{const Z=M.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,G=g.__webglDepthbuffer[Y];i.bindRenderbuffer(i.RENDERBUFFER,G),i.framebufferRenderbuffer(i.FRAMEBUFFER,Z,i.RENDERBUFFER,G)}}else if(t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer===void 0)g.__webglDepthbuffer=i.createRenderbuffer(),oe(g.__webglDepthbuffer,M,!1);else{const Y=M.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Z=g.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,Z),i.framebufferRenderbuffer(i.FRAMEBUFFER,Y,i.RENDERBUFFER,Z)}t.bindFramebuffer(i.FRAMEBUFFER,null)}function Ue(M,g,O){const Y=n.get(M);g!==void 0&&ge(Y.__webglFramebuffer,M,M.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),O!==void 0&&we(M)}function it(M){const g=M.texture,O=n.get(M),Y=n.get(g);M.addEventListener("dispose",R);const Z=M.textures,G=M.isWebGLCubeRenderTarget===!0,_e=Z.length>1;if(_e||(Y.__webglTexture===void 0&&(Y.__webglTexture=i.createTexture()),Y.__version=g.version,o.memory.textures++),G){O.__webglFramebuffer=[];for(let ae=0;ae<6;ae++)if(g.mipmaps&&g.mipmaps.length>0){O.__webglFramebuffer[ae]=[];for(let de=0;de<g.mipmaps.length;de++)O.__webglFramebuffer[ae][de]=i.createFramebuffer()}else O.__webglFramebuffer[ae]=i.createFramebuffer()}else{if(g.mipmaps&&g.mipmaps.length>0){O.__webglFramebuffer=[];for(let ae=0;ae<g.mipmaps.length;ae++)O.__webglFramebuffer[ae]=i.createFramebuffer()}else O.__webglFramebuffer=i.createFramebuffer();if(_e)for(let ae=0,de=Z.length;ae<de;ae++){const Ve=n.get(Z[ae]);Ve.__webglTexture===void 0&&(Ve.__webglTexture=i.createTexture(),o.memory.textures++)}if(M.samples>0&&Be(M)===!1){O.__webglMultisampledFramebuffer=i.createFramebuffer(),O.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,O.__webglMultisampledFramebuffer);for(let ae=0;ae<Z.length;ae++){const de=Z[ae];O.__webglColorRenderbuffer[ae]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,O.__webglColorRenderbuffer[ae]);const Ve=r.convert(de.format,de.colorSpace),ee=r.convert(de.type),fe=T(de.internalFormat,Ve,ee,de.colorSpace,M.isXRRenderTarget===!0),Ee=Oe(M);i.renderbufferStorageMultisample(i.RENDERBUFFER,Ee,fe,M.width,M.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ae,i.RENDERBUFFER,O.__webglColorRenderbuffer[ae])}i.bindRenderbuffer(i.RENDERBUFFER,null),M.depthBuffer&&(O.__webglDepthRenderbuffer=i.createRenderbuffer(),oe(O.__webglDepthRenderbuffer,M,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(G){t.bindTexture(i.TEXTURE_CUBE_MAP,Y.__webglTexture),Ie(i.TEXTURE_CUBE_MAP,g);for(let ae=0;ae<6;ae++)if(g.mipmaps&&g.mipmaps.length>0)for(let de=0;de<g.mipmaps.length;de++)ge(O.__webglFramebuffer[ae][de],M,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ae,de);else ge(O.__webglFramebuffer[ae],M,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0);p(g)&&h(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(_e){for(let ae=0,de=Z.length;ae<de;ae++){const Ve=Z[ae],ee=n.get(Ve);t.bindTexture(i.TEXTURE_2D,ee.__webglTexture),Ie(i.TEXTURE_2D,Ve),ge(O.__webglFramebuffer,M,Ve,i.COLOR_ATTACHMENT0+ae,i.TEXTURE_2D,0),p(Ve)&&h(i.TEXTURE_2D)}t.unbindTexture()}else{let ae=i.TEXTURE_2D;if((M.isWebGL3DRenderTarget||M.isWebGLArrayRenderTarget)&&(ae=M.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(ae,Y.__webglTexture),Ie(ae,g),g.mipmaps&&g.mipmaps.length>0)for(let de=0;de<g.mipmaps.length;de++)ge(O.__webglFramebuffer[de],M,g,i.COLOR_ATTACHMENT0,ae,de);else ge(O.__webglFramebuffer,M,g,i.COLOR_ATTACHMENT0,ae,0);p(g)&&h(ae),t.unbindTexture()}M.depthBuffer&&we(M)}function He(M){const g=M.textures;for(let O=0,Y=g.length;O<Y;O++){const Z=g[O];if(p(Z)){const G=b(M),_e=n.get(Z).__webglTexture;t.bindTexture(G,_e),h(G),t.unbindTexture()}}}const ct=[],A=[];function Dt(M){if(M.samples>0){if(Be(M)===!1){const g=M.textures,O=M.width,Y=M.height;let Z=i.COLOR_BUFFER_BIT;const G=M.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,_e=n.get(M),ae=g.length>1;if(ae)for(let de=0;de<g.length;de++)t.bindFramebuffer(i.FRAMEBUFFER,_e.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+de,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,_e.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+de,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,_e.__webglMultisampledFramebuffer),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,_e.__webglFramebuffer);for(let de=0;de<g.length;de++){if(M.resolveDepthBuffer&&(M.depthBuffer&&(Z|=i.DEPTH_BUFFER_BIT),M.stencilBuffer&&M.resolveStencilBuffer&&(Z|=i.STENCIL_BUFFER_BIT)),ae){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,_e.__webglColorRenderbuffer[de]);const Ve=n.get(g[de]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Ve,0)}i.blitFramebuffer(0,0,O,Y,0,0,O,Y,Z,i.NEAREST),c===!0&&(ct.length=0,A.length=0,ct.push(i.COLOR_ATTACHMENT0+de),M.depthBuffer&&M.resolveDepthBuffer===!1&&(ct.push(G),A.push(G),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,A)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,ct))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),ae)for(let de=0;de<g.length;de++){t.bindFramebuffer(i.FRAMEBUFFER,_e.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+de,i.RENDERBUFFER,_e.__webglColorRenderbuffer[de]);const Ve=n.get(g[de]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,_e.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+de,i.TEXTURE_2D,Ve,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,_e.__webglMultisampledFramebuffer)}else if(M.depthBuffer&&M.resolveDepthBuffer===!1&&c){const g=M.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[g])}}}function Oe(M){return Math.min(s.maxSamples,M.samples)}function Be(M){const g=n.get(M);return M.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function ye(M){const g=o.render.frame;u.get(M)!==g&&(u.set(M,g),M.update())}function tt(M,g){const O=M.colorSpace,Y=M.format,Z=M.type;return M.isCompressedTexture===!0||M.isVideoTexture===!0||O!==Ti&&O!==Mn&&(qe.getTransfer(O)===Je?(Y!==Xt||Z!==mn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",O)),g}function ve(M){return typeof HTMLImageElement<"u"&&M instanceof HTMLImageElement?(l.width=M.naturalWidth||M.width,l.height=M.naturalHeight||M.height):typeof VideoFrame<"u"&&M instanceof VideoFrame?(l.width=M.displayWidth,l.height=M.displayHeight):(l.width=M.width,l.height=M.height),l}this.allocateTextureUnit=z,this.resetTextureUnits=W,this.setTexture2D=j,this.setTexture2DArray=q,this.setTexture3D=J,this.setTextureCube=V,this.rebindTextures=Ue,this.setupRenderTarget=it,this.updateRenderTargetMipmap=He,this.updateMultisampleRenderTarget=Dt,this.setupDepthRenderbuffer=we,this.setupFrameBufferTexture=ge,this.useMultisampledRTT=Be}function lg(i,e){function t(n,s=Mn){let r;const o=qe.getTransfer(s);if(n===mn)return i.UNSIGNED_BYTE;if(n===Do)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Io)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Sc)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===xc)return i.BYTE;if(n===yc)return i.SHORT;if(n===ki)return i.UNSIGNED_SHORT;if(n===Lo)return i.INT;if(n===$n)return i.UNSIGNED_INT;if(n===dn)return i.FLOAT;if(n===Hi)return i.HALF_FLOAT;if(n===Mc)return i.ALPHA;if(n===Ec)return i.RGB;if(n===Xt)return i.RGBA;if(n===Tc)return i.LUMINANCE;if(n===bc)return i.LUMINANCE_ALPHA;if(n===_i)return i.DEPTH_COMPONENT;if(n===Ei)return i.DEPTH_STENCIL;if(n===Ac)return i.RED;if(n===Uo)return i.RED_INTEGER;if(n===wc)return i.RG;if(n===No)return i.RG_INTEGER;if(n===Fo)return i.RGBA_INTEGER;if(n===Es||n===Ts||n===bs||n===As)if(o===Je)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===Es)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Ts)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===bs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===As)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===Es)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Ts)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===bs)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===As)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===jr||n===Zr||n===Jr||n===Qr)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===jr)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Zr)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Jr)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Qr)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===eo||n===to||n===no)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===eo||n===to)return o===Je?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===no)return o===Je?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===io||n===so||n===ro||n===oo||n===ao||n===co||n===lo||n===ho||n===uo||n===fo||n===po||n===mo||n===go||n===_o)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===io)return o===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===so)return o===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===ro)return o===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===oo)return o===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===ao)return o===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===co)return o===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===lo)return o===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===ho)return o===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===uo)return o===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===fo)return o===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===po)return o===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===mo)return o===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===go)return o===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===_o)return o===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===ws||n===vo||n===xo)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===ws)return o===Je?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===vo)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===xo)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Rc||n===yo||n===So||n===Mo)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===ws)return r.COMPRESSED_RED_RGTC1_EXT;if(n===yo)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===So)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Mo)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Mi?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const hg={type:"move"};class Sr{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new ps,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new ps,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new N,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new N),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new ps,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new N,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new N),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let s=null,r=null,o=null;const a=this._targetRay,c=this._grip,l=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(l&&e.hand){o=!0;for(const y of e.hand.values()){const p=t.getJointPose(y,n),h=this._getHandJoint(l,y);p!==null&&(h.matrix.fromArray(p.transform.matrix),h.matrix.decompose(h.position,h.rotation,h.scale),h.matrixWorldNeedsUpdate=!0,h.jointRadius=p.radius),h.visible=p!==null}const u=l.joints["index-finger-tip"],d=l.joints["thumb-tip"],f=u.position.distanceTo(d.position),m=.02,v=.005;l.inputState.pinching&&f>m+v?(l.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!l.inputState.pinching&&f<=m-v&&(l.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else c!==null&&e.gripSpace&&(r=t.getPose(e.gripSpace,n),r!==null&&(c.matrix.fromArray(r.transform.matrix),c.matrix.decompose(c.position,c.rotation,c.scale),c.matrixWorldNeedsUpdate=!0,r.linearVelocity?(c.hasLinearVelocity=!0,c.linearVelocity.copy(r.linearVelocity)):c.hasLinearVelocity=!1,r.angularVelocity?(c.hasAngularVelocity=!0,c.angularVelocity.copy(r.angularVelocity)):c.hasAngularVelocity=!1));a!==null&&(s=t.getPose(e.targetRaySpace,n),s===null&&r!==null&&(s=r),s!==null&&(a.matrix.fromArray(s.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,s.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(s.linearVelocity)):a.hasLinearVelocity=!1,s.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(s.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(hg)))}return a!==null&&(a.visible=s!==null),c!==null&&(c.visible=r!==null),l!==null&&(l.visible=o!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new ps;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}const ug=`
void main() {
...
}`;class fg{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t,n){if(this.texture===null){const s=new Rt,r=e.properties.get(s);r.__webglTexture=t.texture,(t.depthNear!==n.depthNear||t.depthFar!==n.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=s}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new Rn({vertexShader:ug,fragmentShader:dg,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new qt(new Os(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class pg extends jn{constructor(e,t){super();const n=this;let s=null,r=1,o=null,a="local-floor",c=1,l=null,u=null,d=null,f=null,m=null,v=null;const y=new fg,p=t.getContextAttributes();let h=null,b=null;const T=[],E=[],U=new je;let P=null;const R=new ut;R.viewport=new ot;const F=new ut;F.viewport=new ot;const S=[R,F],x=new Du;let C=null,W=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(X){let te=T[X];return te===void 0&&(te=new Sr,T[X]=te),te.getTargetRaySpace()},this.getControllerGrip=function(X){let te=T[X];return te===void 0&&(te=new Sr,T[X]=te),te.getGripSpace()},this.getHand=function(X){let te=T[X];return te===void 0&&(te=new Sr,T[X]=te),te.getHandSpace()};function z(X){const te=E.indexOf(X.inputSource);if(te===-1)return;const ge=T[te];ge!==void 0&&(ge.update(X.inputSource,X.frame,l||o),ge.dispatchEvent({type:X.type,data:X.inputSource}))}function K(){s.removeEventListener("select",z),s.removeEventListener("selectstart",z),s.removeEventListener("selectend",z),s.removeEventListener("squeeze",z),s.removeEventListener("squeezestart",z),s.removeEventListener("squeezeend",z),s.removeEventListener("end",K),s.removeEventListener("inputsourceschange",j);for(let X=0;X<T.length;X++){const te=E[X];te!==null&&(E[X]=null,T[X].disconnect(te))}C=null,W=null,y.reset(),e.setRenderTarget(h),m=null,f=null,d=null,s=null,b=null,Qe.stop(),n.isPresenting=!1,e.setPixelRatio(P),e.setSize(U.width,U.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(X){r=X,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(X){a=X,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||o},this.setReferenceSpace=function(X){l=X},this.getBaseLayer=function(){return f!==null?f:m},this.getBinding=function(){return d},this.getFrame=function(){return v},this.getSession=function(){return s},this.setSession=async function(X){if(s=X,s!==null){if(h=e.getRenderTarget(),s.addEventListener("select",z),s.addEventListener("selectstart",z),s.addEventListener("selectend",z),s.addEventListener("squeeze",z),s.addEventListener("squeezestart",z),s.addEventListener("squeezeend",z),s.addEventListener("end",K),s.addEventListener("inputsourceschange",j),p.xrCompatible!==!0&&await t.makeXRCompatible(),P=e.getPixelRatio(),e.getSize(U),s.enabledFeatures!==void 0&&s.enabledFeatures.includes("layers")){let ge=null,oe=null,Te=null;p.depth&&(Te=p.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,ge=p.stencil?Ei:_i,oe=p.stencil?Mi:$n);const we={colorFormat:t.RGBA8,depthFormat:Te,scaleFactor:r};d=new XRWebGLBinding(s,t),f=d.createProjectionLayer(we),s.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),b=new Kn(f.textureWidth,f.textureHeight,{format:Xt,type:mn,depthTexture:new Hc(f.textureWidth,f.textureHeight,oe,void 0,void 0,void 0,void 0,void 0,void 0,ge),stencilBuffer:p.stencil,colorSpace:e.outputColorSpace,samples:p.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1})}else{const ge={antialias:p.antialias,alpha:!0,depth:p.depth,stencil:p.stencil,framebufferScaleFactor:r};m=new XRWebGLLayer(s,t,ge),s.updateRenderState({baseLayer:m}),e.setPixelRatio(1),e.setSize(m.framebufferWidth,m.framebufferHeight,!1),b=new Kn(m.framebufferWidth,m.framebufferHeight,{format:Xt,type:mn,colorSpace:e.outputColorSpace,stencilBuffer:p.stencil})}b.isXRRenderTarget=!0,this.setFoveation(c),l=null,o=await s.requestReferenceSpace(a),Qe.setContext(s),Qe.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return y.getDepthTexture()};function j(X){for(let te=0;te<X.removed.length;te++){const ge=X.removed[te],oe=E.indexOf(ge);oe>=0&&(E[oe]=null,T[oe].disconnect(ge))}for(let te=0;te<X.added.length;te++){const ge=X.added[te];let oe=E.indexOf(ge);if(oe===-1){for(let we=0;we<T.length;we++)if(we>=E.length){E.push(ge),oe=we;break}else if(E[we]===null){E[we]=ge,oe=we;break}if(oe===-1)break}const Te=T[oe];Te&&Te.connect(ge)}}const q=new N,J=new N;function V(X,te,ge){q.setFromMatrixPosition(te.matrixWorld),J.setFromMatrixPosition(ge.matrixWorld);const oe=q.distanceTo(J),Te=te.projectionMatrix.elements,we=ge.projectionMatrix.elements,Ue=Te[14]/(Te[10]-1),it=Te[14]/(Te[10]+1),He=(Te[9]+1)/Te[5],ct=(Te[9]-1)/Te[5],A=(Te[8]-1)/Te[0],Dt=(we[8]+1)/we[0],Oe=Ue*A,Be=Ue*Dt,ye=oe/(-A+Dt),tt=ye*-A;if(te.matrixWorld.decompose(X.position,X.quaternion,X.scale),X.translateX(tt),X.translateZ(ye),X.matrixWorld.compose(X.position,X.quaternion,X.scale),X.matrixWorldInverse.copy(X.matrixWorld).invert(),Te[10]===-1)X.projectionMatrix.copy(te.projectionMatrix),X.projectionMatrixInverse.copy(te.projectionMatrixInverse);else{const ve=Ue+ye,M=it+ye,g=Oe-tt,O=Be+(oe-tt),Y=He*it/M*ve,Z=ct*it/M*ve;X.projectionMatrix.makePerspective(g,O,Y,Z,ve,M),X.projectionMatrixInverse.copy(X.projectionMatrix).invert()}}function re(X,te){te===null?X.matrixWorld.copy(X.matrix):X.matrixWorld.multiplyMatrices(te.matrixWorld,X.matrix),X.matrixWorldInverse.copy(X.matrixWorld).invert()}this.updateCamera=function(X){if(s===null)return;let te=X.near,ge=X.far;y.texture!==null&&(y.depthNear>0&&(te=y.depthNear),y.depthFar>0&&(ge=y.depthFar)),x.near=F.near=R.near=te,x.far=F.far=R.far=ge,(C!==x.near||W!==x.far)&&(s.updateRenderState({depthNear:x.near,depthFar:x.far}),C=x.near,W=x.far),R.layers.mask=X.layers.mask|2,F.layers.mask=X.layers.mask|4,x.layers.mask=R.layers.mask|F.layers.mask;const oe=X.parent,Te=x.cameras;re(x,oe);for(let we=0;we<Te.length;we++)re(Te[we],oe);Te.length===2?V(x,R,F):x.projectionMatrix.copy(R.projectionMatrix),ue(X,x,oe)};function ue(X,te,ge){ge===null?X.matrix.copy(te.matrixWorld):(X.matrix.copy(ge.matrixWorld),X.matrix.invert(),X.matrix.multiply(te.matrixWorld)),X.matrix.decompose(X.position,X.quaternion,X.scale),X.updateMatrixWorld(!0),X.projectionMatrix.copy(te.projectionMatrix),X.projectionMatrixInverse.copy(te.projectionMatrixInverse),X.isPerspectiveCamera&&(X.fov=Eo*2*Math.atan(1/X.projectionMatrix.elements[5]),X.zoom=1)}this.getCamera=function(){return x},this.getFoveation=function(){if(!(f===null&&m===null))return c},this.setFoveation=function(X){c=X,f!==null&&(f.fixedFoveation=X),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=X)},this.hasDepthSensing=function(){return y.texture!==null},this.getDepthSensingMesh=function(){return y.getMesh(x)};let xe=null;function Ie(X,te){if(u=te.getViewerPose(l||o),v=te,u!==null){const ge=u.views;m!==null&&(e.setRenderTargetFramebuffer(b,m.framebuffer),e.setRenderTarget(b));let oe=!1;ge.length!==x.cameras.length&&(x.cameras.length=0,oe=!0);for(let we=0;we<ge.length;we++){const Ue=ge[we];let it=null;if(m!==null)it=m.getViewport(Ue);else{const ct=d.getViewSubImage(f,Ue);it=ct.viewport,we===0&&(e.setRenderTargetTextures(b,ct.colorTexture,f.ignoreDepthValues?void 0:ct.depthStencilTexture),e.setRenderTarget(b))}let He=S[we];He===void 0&&(He=new ut,He.layers.enable(we),He.viewport=new ot,S[we]=He),He.matrix.fromArray(Ue.transform.matrix),He.matrix.decompose(He.position,He.quaternion,He.scale),He.projectionMatrix.fromArray(Ue.projectionMatrix),He.projectionMatrixInverse.copy(He.projectionMatrix).invert(),He.viewport.set(it.x,it.y,it.width,it.height),we===0&&(x.matrix.copy(He.matrix),x.matrix.decompose(x.position,x.quaternion,x.scale)),oe===!0&&x.cameras.push(He)}const Te=s.enabledFeatures;if(Te&&Te.includes("depth-sensing")){const we=d.getDepthInformation(ge[0]);we&&we.isValid&&we.texture&&y.init(e,we,s.renderState)}}for(let ge=0;ge<T.length;ge++){const oe=E[ge],Te=T[ge];oe!==null&&Te!==void 0&&Te.update(oe,te,l||o)}xe&&xe(X,te),te.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:te}),v=null}const Qe=new Wc;Qe.setAnimationLoop(Ie),this.setAnimationLoop=function(X){xe=X},this.dispose=function(){}}}const kn=new $t,mg=new at;function gg(i,e){function t(p,h){p.matrixAutoUpdate===!0&&p.updateMatrix(),h.value.copy(p.matrix)}function n(p,h){h.color.getRGB(p.fogColor.value,Bc(i)),h.isFog?(p.fogNear.value=h.near,p.fogFar.value=h.far):h.isFogExp2&&(p.fogDensity.value=h.density)}function s(p,h,b,T,E){h.isMeshBasicMaterial||h.isMeshLambertMaterial?r(p,h):h.isMeshToonMaterial?(r(p,h),d(p,h)):h.isMeshPhongMaterial?(r(p,h),u(p,h)):h.isMeshStandardMaterial?(r(p,h),f(p,h),h.isMeshPhysicalMaterial&&m(p,h,E)):h.isMeshMatcapMaterial?(r(p,h),v(p,h)):h.isMeshDepthMaterial?r(p,h):h.isMeshDistanceMaterial?(r(p,h),y(p,h)):h.isMeshNormalMaterial?r(p,h):h.isLineBasicMaterial?(o(p,h),h.isLineDashedMaterial&&a(p,h)):h.isPointsMaterial?c(p,h,b,T):h.isSpriteMaterial?l(p,h):h.isShadowMaterial?(p.color.value.copy(h.color),p.opacity.value=h.opacity):h.isShaderMaterial&&(h.uniformsNeedUpdate=!1)}function r(p,h){p.opacity.value=h.opacity,h.color&&p.diffuse.value.copy(h.color),h.emissive&&p.emissive.value.copy(h.emissive).multiplyScalar(h.emissiveIntensity),h.map&&(p.map.value=h.map,t(h.map,p.mapTransform)),h.alphaMap&&(p.alphaMap.value=h.alphaMap,t(h.alphaMap,p.alphaMapTransform)),h.bumpMap&&(p.bumpMap.value=h.bumpMap,t(h.bumpMap,p.bumpMapTransform),p.bumpScale.value=h.bumpScale,h.side===wt&&(p.bumpScale.value*=-1)),h.normalMap&&(p.normalMap.value=h.normalMap,t(h.normalMap,p.normalMapTransform),p.normalScale.value.copy(h.normalScale),h.side===wt&&p.normalScale.value.negate()),h.displacementMap&&(p.displacementMap.value=h.displacementMap,t(h.displacementMap,p.displacementMapTransform),p.displacementScale.value=h.displacementScale,p.displacementBias.value=h.displacementBias),h.emissiveMap&&(p.emissiveMap.value=h.emissiveMap,t(h.emissiveMap,p.emissiveMapTransform)),h.specularMap&&(p.specularMap.value=h.specularMap,t(h.specularMap,p.specularMapTransform)),h.alphaTest>0&&(p.alphaTest.value=h.alphaTest);const b=e.get(h),T=b.envMap,E=b.envMapRotation;T&&(p.envMap.value=T,kn.copy(E),kn.x*=-1,kn.y*=-1,kn.z*=-1,T.isCubeTexture&&T.isRenderTargetTexture===!1&&(kn.y*=-1,kn.z*=-1),p.envMapRotation.value.setFromMatrix4(mg.makeRotationFromEuler(kn)),p.flipEnvMap.value=T.isCubeTexture&&T.isRenderTargetTexture===!1?-1:1,p.reflectivity.value=h.reflectivity,p.ior.value=h.ior,p.refractionRatio.value=h.refractionRatio),h.lightMap&&(p.lightMap.value=h.lightMap,p.lightMapIntensity.value=h.lightMapIntensity,t(h.lightMap,p.lightMapTransform)),h.aoMap&&(p.aoMap.value=h.aoMap,p.aoMapIntensity.value=h.aoMapIntensity,t(h.aoMap,p.aoMapTransform))}function o(p,h){p.diffuse.value.copy(h.color),p.opacity.value=h.opacity,h.map&&(p.map.value=h.map,t(h.map,p.mapTransform))}function a(p,h){p.dashSize.value=h.dashSize,p.totalSize.value=h.dashSize+h.gapSize,p.scale.value=h.scale}function c(p,h,b,T){p.diffuse.value.copy(h.color),p.opacity.value=h.opacity,p.size.value=h.size*b,p.scale.value=T*.5,h.map&&(p.map.value=h.map,t(h.map,p.uvTransform)),h.alphaMap&&(p.alphaMap.value=h.alphaMap,t(h.alphaMap,p.alphaMapTransform)),h.alphaTest>0&&(p.alphaTest.value=h.alphaTest)}function l(p,h){p.diffuse.value.copy(h.color),p.opacity.value=h.opacity,p.rotation.value=h.rotation,h.map&&(p.map.value=h.map,t(h.map,p.mapTransform)),h.alphaMap&&(p.alphaMap.value=h.alphaMap,t(h.alphaMap,p.alphaMapTransform)),h.alphaTest>0&&(p.alphaTest.value=h.alphaTest)}function u(p,h){p.specular.value.copy(h.specular),p.shininess.value=Math.max(h.shininess,1e-4)}function d(p,h){h.gradientMap&&(p.gradientMap.value=h.gradientMap)}function f(p,h){p.metalness.value=h.metalness,h.metalnessMap&&(p.metalnessMap.value=h.metalnessMap,t(h.metalnessMap,p.metalnessMapTransform)),p.roughness.value=h.roughness,h.roughnessMap&&(p.roughnessMap.value=h.roughnessMap,t(h.roughnessMap,p.roughnessMapTransform)),h.envMap&&(p.envMapIntensity.value=h.envMapIntensity)}function m(p,h,b){p.ior.value=h.ior,h.sheen>0&&(p.sheenColor.value.copy(h.sheenColor).multiplyScalar(h.sheen),p.sheenRoughness.value=h.sheenRoughness,h.sheenColorMap&&(p.sheenColorMap.value=h.sheenColorMap,t(h.sheenColorMap,p.sheenColorMapTransform)),h.sheenRoughnessMap&&(p.sheenRoughnessMap.value=h.sheenRoughnessMap,t(h.sheenRoughnessMap,p.sheenRoughnessMapTransform))),h.clearcoat>0&&(p.clearcoat.value=h.clearcoat,p.clearcoatRoughness.value=h.clearcoatRoughness,h.clearcoatMap&&(p.clearcoatMap.value=h.clearcoatMap,t(h.clearcoatMap,p.clearcoatMapTransform)),h.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=h.clearcoatRoughnessMap,t(h.clearcoatRoughnessMap,p.clearcoatRoughnessMapTransform)),h.clearcoatNormalMap&&(p.clearcoatNormalMap.value=h.clearcoatNormalMap,t(h.clearcoatNormalMap,p.clearcoatNormalMapTransform),p.clearcoatNormalScale.value.copy(h.clearcoatNormalScale),h.side===wt&&p.clearcoatNormalScale.value.negate())),h.dispersion>0&&(p.dispersion.value=h.dispersion),h.iridescence>0&&(p.iridescence.value=h.iridescence,p.iridescenceIOR.value=h.iridescenceIOR,p.iridescenceThicknessMinimum.value=h.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=h.iridescenceThicknessRange[1],h.iridescenceMap&&(p.iridescenceMap.value=h.iridescenceMap,t(h.iridescenceMap,p.iridescenceMapTransform)),h.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=h.iridescenceThicknessMap,t(h.iridescenceThicknessMap,p.iridescenceThicknessMapTransform))),h.transmission>0&&(p.transmission.value=h.transmission,p.transmissionSamplerMap.value=b.texture,p.transmissionSamplerSize.value.set(b.width,b.height),h.transmissionMap&&(p.transmissionMap.value=h.transmissionMap,t(h.transmissionMap,p.transmissionMapTransform)),p.thickness.value=h.thickness,h.thicknessMap&&(p.thicknessMap.value=h.thicknessMap,t(h.thicknessMap,p.thicknessMapTransform)),p.attenuationDistance.value=h.attenuationDistance,p.attenuationColor.value.copy(h.attenuationColor)),h.anisotropy>0&&(p.anisotropyVector.value.set(h.anisotropy*Math.cos(h.anisotropyRotation),h.anisotropy*Math.sin(h.anisotropyRotation)),h.anisotropyMap&&(p.anisotropyMap.value=h.anisotropyMap,t(h.anisotropyMap,p.anisotropyMapTransform))),p.specularIntensity.value=h.specularIntensity,p.specularColor.value.copy(h.specularColor),h.specularColorMap&&(p.specularColorMap.value=h.specularColorMap,t(h.specularColorMap,p.specularColorMapTransform)),h.specularIntensityMap&&(p.specularIntensityMap.value=h.specularIntensityMap,t(h.specularIntensityMap,p.specularIntensityMapTransform))}function v(p,h){h.matcap&&(p.matcap.value=h.matcap)}function y(p,h){const b=e.get(h).light;p.referencePosition.value.setFromMatrixPosition(b.matrixWorld),p.nearDistance.value=b.shadow.camera.near,p.farDistance.value=b.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:s}}function _g(i,e,t,n){let s={},r={},o=[];const a=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function c(b,T){const E=T.program;n.uniformBlockBinding(b,E)}function l(b,T){let E=s[b.id];E===void 0&&(v(b),E=u(b),s[b.id]=E,b.addEventListener("dispose",p));const U=T.program;n.updateUBOMapping(b,U);const P=e.render.frame;r[b.id]!==P&&(f(b),r[b.id]=P)}function u(b){const T=d();b.__bindingPointIndex=T;const E=i.createBuffer(),U=b.__size,P=b.usage;return i.bindBuffer(i.UNIFORM_BUFFER,E),i.bufferData(i.UNIFORM_BUFFER,U,P),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,T,E),E}function d(){for(let b=0;b<a;b++)if(o.indexOf(b)===-1)return o.push(b),b;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(b){const T=s[b.id],E=b.uniforms,U=b.__cache;i.bindBuffer(i.UNIFORM_BUFFER,T);for(let P=0,R=E.length;P<R;P++){const F=Array.isArray(E[P])?E[P]:[E[P]];for(let S=0,x=F.length;S<x;S++){const C=F[S];if(m(C,P,S,U)===!0){const W=C.__offset,z=Array.isArray(C.value)?C.value:[C.value];let K=0;for(let j=0;j<z.length;j++){const q=z[j],J=y(q);typeof q=="number"||typeof q=="boolean"?(C.__data[0]=q,i.bufferSubData(i.UNIFORM_BUFFER,W+K,C.__data)):q.isMatrix3?(C.__data[0]=q.elements[0],C.__data[1]=q.elements[1],C.__data[2]=q.elements[2],C.__data[3]=0,C.__data[4]=q.elements[3],C.__data[5]=q.elements[4],C.__data[6]=q.elements[5],C.__data[7]=0,C.__data[8]=q.elements[6],C.__data[9]=q.elements[7],C.__data[10]=q.elements[8],C.__data[11]=0):(q.toArray(C.__data,K),K+=J.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,W,C.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function m(b,T,E,U){const P=b.value,R=T+"_"+E;if(U[R]===void 0)return typeof P=="number"||typeof P=="boolean"?U[R]=P:U[R]=P.clone(),!0;{const F=U[R];if(typeof P=="number"||typeof P=="boolean"){if(F!==P)return U[R]=P,!0}else if(F.equals(P)===!1)return F.copy(P),!0}return!1}function v(b){const T=b.uniforms;let E=0;const U=16;for(let R=0,F=T.length;R<F;R++){const S=Array.isArray(T[R])?T[R]:[T[R]];for(let x=0,C=S.length;x<C;x++){const W=S[x],z=Array.isArray(W.value)?W.value:[W.value];for(let K=0,j=z.length;K<j;K++){const q=z[K],J=y(q),V=E%U,re=V%J.boundary,ue=V+re;E+=re,ue!==0&&U-ue<J.storage&&(E+=U-ue),W.__data=new Float32Array(J.storage/Float32Array.BYTES_PER_ELEMENT),W.__offset=E,E+=J.storage}}}const P=E%U;return P>0&&(E+=U-P),b.__size=E,b.__cache={},this}function y(b){const T={boundary:0,storage:0};return typeof b=="number"||typeof b=="boolean"?(T.boundary=4,T.storage=4):b.isVector2?(T.boundary=8,T.storage=8):b.isVector3||b.isColor?(T.boundary=16,T.storage=12):b.isVector4?(T.boundary=16,T.storage=16):b.isMatrix3?(T.boundary=48,T.storage=48):b.isMatrix4?(T.boundary=64,T.storage=64):b.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",b),T}function p(b){const T=b.target;T.removeEventListener("dispose",p);const E=o.indexOf(T.__bindingPointIndex);o.splice(E,1),i.deleteBuffer(s[T.id]),delete s[T.id],delete r[T.id]}function h(){for(const b in s)i.deleteBuffer(s[b]);o=[],s={},r={}}return{bind:c,update:l,dispose:h}}class Ln{constructor(e={}){const{canvas:t=jh(),context:n=null,depth:s=!0,stencil:r=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:l=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:d=!1,reverseDepthBuffer:f=!1}=e;this.isWebGLRenderer=!0;let m;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");m=n.getContextAttributes().alpha}else m=o;const v=new Uint32Array(4),y=new Int32Array(4);let p=null,h=null;const b=[],T=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=Ft,this.toneMapping=An,this.toneMappingExposure=1;const E=this;let U=!1,P=0,R=0,F=null,S=-1,x=null;const C=new ot,W=new ot;let z=null;const K=new Ye(0);let j=0,q=t.width,J=t.height,V=1,re=null,ue=null;const xe=new ot(0,0,q,J),Ie=new ot(0,0,q,J);let Qe=!1;const X=new ko;let te=!1,ge=!1;this.transmissionResolutionScale=1;const oe=new at,Te=new at,we=new N,Ue=new ot,it={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let He=!1;function ct(){return F===null?V:1}let A=n;function Dt(_,D){return t.getContext(_,D)}try{const _={alpha:!0,depth:s,stencil:r,antialias:a,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:u,failIfMajorPerformanceCaveat:d};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${Po}`),t.addEventListener("webglcontextlost",$,!1),t.addEventListener("webglcontextrestored",le,!1),t.addEventListener("webglcontextcreationerror",ce,!1),A===null){const D="webgl2";if(A=Dt(D,_),A===null)throw Dt(D)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(_){throw console.error("THREE.WebGLRenderer: "+_.message),_}let Oe,Be,ye,tt,ve,M,g,O,Y,Z,G,_e,ae,de,Ve,ee,fe,Ee,be,pe,ke,Le,et,L;function ie(){Oe=new wp(A),Oe.init(),Le=new lg(A,Oe),Be=new Sp(A,Oe,e,Le),ye=new ag(A,Oe),Be.reverseDepthBuffer&&f&&ye.buffers.depth.setReversed(!0),tt=new Pp(A),ve=new $m,M=new cg(A,Oe,ye,ve,Be,Le,tt),g=new Ep(E),O=new Ap(E),Y=new Fu(A),et=new xp(A,Y),Z=new Rp(A,Y,tt,et),G=new Dp(A,Z,Y,tt),be=new Lp(A,Be,M),ee=new Mp(ve),_e=new Ym(E,g,O,Oe,Be,et,ee),ae=new gg(E,ve),de=new jm,Ve=new ng(Oe),Ee=new vp(E,g,O,ye,G,m,c),fe=new rg(E,G,Be),L=new _g(A,tt,Be,ye),pe=new yp(A,Oe,tt),ke=new Cp(A,Oe,tt),tt.programs=_e.programs,E.capabilities=Be,E.extensions=Oe,E.properties=ve,E.renderLists=de,E.shadowMap=fe,E.state=ye,E.info=tt}ie();const H=new pg(E,A);this.xr=H,this.getContext=function(){return A},this.getContextAttributes=function(){return A.getContextAttributes()},this.forceContextLoss=function(){const _=Oe.get("WEBGL_lose_context");_&&_.loseContext()},this.forceContextRestore=function(){const _=Oe.get("WEBGL_lose_context");_&&_.restoreContext()},this.getPixelRatio=function(){return V},this.setPixelRatio=function(_){_!==void 0&&(V=_,this.setSize(q,J,!1))},this.getSize=function(_){return _.set(q,J)},this.setSize=function(_,D,B=!0){if(H.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}q=_,J=D,t.width=Math.floor(_*V),t.height=Math.floor(D*V),B===!0&&(t.style.width=_+"px",t.style.height=D+"px"),this.setViewport(0,0,_,D)},this.getDrawingBufferSize=function(_){return _.set(q*V,J*V).floor()},this.setDrawingBufferSize=function(_,D,B){q=_,J=D,V=B,t.width=Math.floor(_*B),t.height=Math.floor(D*B),this.setViewport(0,0,_,D)},this.getCurrentViewport=function(_){return _.copy(C)},this.getViewport=function(_){return _.copy(xe)},this.setViewport=function(_,D,B,k){_.isVector4?xe.set(_.x,_.y,_.z,_.w):xe.set(_,D,B,k),ye.viewport(C.copy(xe).multiplyScalar(V).round())},this.getScissor=function(_){return _.copy(Ie)},this.setScissor=function(_,D,B,k){_.isVector4?Ie.set(_.x,_.y,_.z,_.w):Ie.set(_,D,B,k),ye.scissor(W.copy(Ie).multiplyScalar(V).round())},this.getScissorTest=function(){return Qe},this.setScissorTest=function(_){ye.setScissorTest(Qe=_)},this.setOpaqueSort=function(_){re=_},this.setTransparentSort=function(_){ue=_},this.getClearColor=function(_){return _.copy(Ee.getClearColor())},this.setClearColor=function(){Ee.setClearColor.apply(Ee,arguments)},this.getClearAlpha=function(){return Ee.getClearAlpha()},this.setClearAlpha=function(){Ee.setClearAlpha.apply(Ee,arguments)},this.clear=function(_=!0,D=!0,B=!0){let k=0;if(_){let I=!1;if(F!==null){const Q=F.texture.format;I=Q===Fo||Q===No||Q===Uo}if(I){const Q=F.texture.type,se=Q===mn||Q===$n||Q===ki||Q===Mi||Q===Do||Q===Io,he=Ee.getClearColor(),me=Ee.getClearAlpha(),Ae=he.r,Re=he.g,Se=he.b;se?(v[0]=Ae,v[1]=Re,v[2]=Se,v[3]=me,A.clearBufferuiv(A.COLOR,0,v)):(y[0]=Ae,y[1]=Re,y[2]=Se,y[3]=me,A.clearBufferiv(A.COLOR,0,y))}else k|=A.COLOR_BUFFER_BIT}D&&(k|=A.DEPTH_BUFFER_BIT),B&&(k|=A.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),A.clear(k)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",$,!1),t.removeEventListener("webglcontextrestored",le,!1),t.removeEventListener("webglcontextcreationerror",ce,!1),Ee.dispose(),de.dispose(),Ve.dispose(),ve.dispose(),g.dispose(),O.dispose(),G.dispose(),et.dispose(),L.dispose(),_e.dispose(),H.dispose(),H.removeEventListener("sessionstart",Go),H.removeEventListener("sessionend",Wo),Dn.stop()};function $(_){_.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),U=!0}function le(){console.log("THREE.WebGLRenderer: Context Restored."),U=!1;const _=tt.autoReset,D=fe.enabled,B=fe.autoUpdate,k=fe.needsUpdate,I=fe.type;ie(),tt.autoReset=_,fe.enabled=D,fe.autoUpdate=B,fe.needsUpdate=k,fe.type=I}function ce(_){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",_.statusMessage)}function Ce(_){const D=_.target;D.removeEventListener("dispose",Ce),st(D)}function st(_){xt(_),ve.remove(_)}function xt(_){const D=ve.get(_).programs;D!==void 0&&(D.forEach(function(B){_e.releaseProgram(B)}),_.isShaderMaterial&&_e.releaseShaderCache(_))}this.renderBufferDirect=function(_,D,B,k,I,Q){D===null&&(D=it);const se=I.isMesh&&I.matrixWorld.determinant()<0,he=Qc(_,D,B,k,I);ye.setMaterial(k,se);let me=B.index,Ae=1;if(k.wireframe===!0){if(me=Z.getWireframeAttribute(B),me===void 0)return;Ae=2}const Re=B.drawRange,Se=B.attributes.position;let Ge=Re.start*Ae,$e=(Re.start+Re.count)*Ae;Q!==null&&(Ge=Math.max(Ge,Q.start*Ae),$e=Math.min($e,(Q.start+Q.count)*Ae)),me!==null?(Ge=Math.max(Ge,0),$e=Math.min($e,me.count)):Se!=null&&(Ge=Math.max(Ge,0),$e=Math.min($e,Se.count));const lt=$e-Ge;if(lt<0||lt===1/0)return;et.setup(I,k,he,B,me);let rt,Xe=pe;if(me!==null&&(rt=Y.get(me),Xe=ke,Xe.setIndex(rt)),I.isMesh)k.wireframe===!0?(ye.setLineWidth(k.wireframeLinewidth*ct()),Xe.setMode(A.LINES)):Xe.setMode(A.TRIANGLES);else if(I.isLine){let Me=k.linewidth;Me===void 0&&(Me=1),ye.setLineWidth(Me*ct()),I.isLineSegments?Xe.setMode(A.LINES):I.isLineLoop?Xe.setMode(A.LINE_LOOP):Xe.setMode(A.LINE_STRIP)}else I.isPoints?Xe.setMode(A.POINTS):I.isSprite&&Xe.setMode(A.TRIANGLES);if(I.isBatchedMesh)if(I._multiDrawInstances!==null)Xe.renderMultiDrawInstances(I._multiDrawStarts,I._multiDrawCounts,I._multiDrawCount,I._multiDrawInstances);else if(Oe.get("WEBGL_multi_draw"))Xe.renderMultiDraw(I._multiDrawStarts,I._multiDrawCounts,I._multiDrawCount);else{const Me=I._multiDrawStarts,vt=I._multiDrawCounts,Ke=I._multiDrawCount,kt=me?Y.get(me).bytesPerElement:1,Zn=ve.get(k).currentProgram.getUniforms();for(let Ct=0;Ct<Ke;Ct++)Zn.setValue(A,"_gl_DrawID",Ct),Xe.render(Me[Ct]/kt,vt[Ct])}else if(I.isInstancedMesh)Xe.renderInstances(Ge,lt,I.count);else if(B.isInstancedBufferGeometry){const Me=B._maxInstanceCount!==void 0?B._maxInstanceCount:1/0,vt=Math.min(B.instanceCount,Me);Xe.renderInstances(Ge,lt,vt)}else Xe.render(Ge,lt)};function Ze(_,D,B){_.transparent===!0&&_.side===hn&&_.forceSinglePass===!1?(_.side=wt,_.needsUpdate=!0,Yi(_,D,B),_.side=wn,_.needsUpdate=!0,Yi(_,D,B),_.side=hn):Yi(_,D,B)}this.compile=function(_,D,B=null){B===null&&(B=_),h=Ve.get(B),h.init(D),T.push(h),B.traverseVisible(function(I){I.isLight&&I.layers.test(D.layers)&&(h.pushLight(I),I.castShadow&&h.pushShadow(I))}),_!==B&&_.traverseVisible(function(I){I.isLight&&I.layers.test(D.layers)&&(h.pushLight(I),I.castShadow&&h.pushShadow(I))}),h.setupLights();const k=new Set;return _.traverse(function(I){if(!(I.isMesh||I.isPoints||I.isLine||I.isSprite))return;const Q=I.material;if(Q)if(Array.isArray(Q))for(let se=0;se<Q.length;se++){const he=Q[se];Ze(he,B,I),k.add(he)}else Ze(Q,B,I),k.add(Q)}),T.pop(),h=null,k},this.compileAsync=function(_,D,B=null){const k=this.compile(_,D,B);return new Promise(I=>{function Q(){if(k.forEach(function(se){ve.get(se).currentProgram.isReady()&&k.delete(se)}),k.size===0){I(_);return}setTimeout(Q,10)}Oe.get("KHR_parallel_shader_compile")!==null?Q():setTimeout(Q,10)})};let Bt=null;function tn(_){Bt&&Bt(_)}function Go(){Dn.stop()}function Wo(){Dn.start()}const Dn=new Wc;Dn.setAnimationLoop(tn),typeof self<"u"&&Dn.setContext(self),this.setAnimationLoop=function(_){Bt=_,H.setAnimationLoop(_),_===null?Dn.stop():Dn.start()},H.addEventListener("sessionstart",Go),H.addEventListener("sessionend",Wo),this.render=function(_,D){if(D!==void 0&&D.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(U===!0)return;if(_.matrixWorldAutoUpdate===!0&&_.updateMatrixWorld(),D.parent===null&&D.matrixWorldAutoUpdate===!0&&D.updateMatrixWorld(),H.enabled===!0&&H.isPresenting===!0&&(H.cameraAutoUpdate===!0&&H.updateCamera(D),D=H.getCamera()),_.isScene===!0&&_.onBeforeRender(E,_,D,F),h=Ve.get(_,T.length),h.init(D),T.push(h),Te.multiplyMatrices(D.projectionMatrix,D.matrixWorldInverse),X.setFromProjectionMatrix(Te),ge=this.localClippingEnabled,te=ee.init(this.clippingPlanes,ge),p=de.get(_,b.length),p.init(),b.push(p),H.enabled===!0&&H.isPresenting===!0){const Q=E.xr.getDepthSensingMesh();Q!==null&&ks(Q,D,-1/0,E.sortObjects)}ks(_,D,0,E.sortObjects),p.finish(),E.sortObjects===!0&&p.sort(re,ue),He=H.enabled===!1||H.isPresenting===!1||H.hasDepthSensing()===!1,He&&Ee.addToRenderList(p,_),this.info.render.frame++,te===!0&&ee.beginShadows();const B=h.state.shadowsArray;fe.render(B,_,D),te===!0&&ee.endShadows(),this.info.autoReset===!0&&this.info.reset();const k=p.opaque,I=p.transmissive;if(h.setupLights(),D.isArrayCamera){const Q=D.cameras;if(I.length>0)for(let se=0,he=Q.length;se<he;se++){const me=Q[se];qo(k,I,_,me)}He&&Ee.render(_);for(let se=0,he=Q.length;se<he;se++){const me=Q[se];Xo(p,_,me,me.viewport)}}else I.length>0&&qo(k,I,_,D),He&&Ee.render(_),Xo(p,_,D);F!==null&&R===0&&(M.updateMultisampleRenderTarget(F),M.updateRenderTargetMipmap(F)),_.isScene===!0&&_.onAfterRender(E,_,D),et.resetDefaultState(),S=-1,x=null,T.pop(),T.length>0?(h=T[T.length-1],te===!0&&ee.setGlobalState(E.clippingPlanes,h.state.camera)):h=null,b.pop(),b.length>0?p=b[b.length-1]:p=null};function ks(_,D,B,k){if(_.visible===!1)return;if(_.layers.test(D.layers)){if(_.isGroup)B=_.renderOrder;else if(_.isLOD)_.autoUpdate===!0&&_.update(D);else if(_.isLight)h.pushLight(_),_.castShadow&&h.pushShadow(_);else if(_.isSprite){if(!_.frustumCulled||X.intersectsSprite(_)){k&&Ue.setFromMatrixPosition(_.matrixWorld).applyMatrix4(Te);const se=G.update(_),he=_.material;he.visible&&p.push(_,se,he,B,Ue.z,null)}}else if((_.isMesh||_.isLine||_.isPoints)&&(!_.frustumCulled||X.intersectsObject(_))){const se=G.update(_),he=_.material;if(k&&(_.boundingSphere!==void 0?(_.boundingSphere===null&&_.computeBoundingSphere(),Ue.copy(_.boundingSphere.center)):(se.boundingSphere===null&&se.computeBoundingSphere(),Ue.copy(se.boundingSphere.center)),Ue.applyMatrix4(_.matrixWorld).applyMatrix4(Te)),Array.isArray(he)){const me=se.groups;for(let Ae=0,Re=me.length;Ae<Re;Ae++){const Se=me[Ae],Ge=he[Se.materialIndex];Ge&&Ge.visible&&p.push(_,se,Ge,B,Ue.z,Se)}}else he.visible&&p.push(_,se,he,B,Ue.z,null)}}const Q=_.children;for(let se=0,he=Q.length;se<he;se++)ks(Q[se],D,B,k)}function Xo(_,D,B,k){const I=_.opaque,Q=_.transmissive,se=_.transparent;h.setupLightsView(B),te===!0&&ee.setGlobalState(E.clippingPlanes,B),k&&ye.viewport(C.copy(k)),I.length>0&&qi(I,D,B),Q.length>0&&qi(Q,D,B),se.length>0&&qi(se,D,B),ye.buffers.depth.setTest(!0),ye.buffers.depth.setMask(!0),ye.buffers.color.setMask(!0),ye.setPolygonOffset(!1)}function qo(_,D,B,k){if((B.isScene===!0?B.overrideMaterial:null)!==null)return;h.state.transmissionRenderTarget[k.id]===void 0&&(h.state.transmissionRenderTarget[k.id]=new Kn(1,1,{generateMipmaps:!0,type:Oe.has("EXT_color_buffer_half_float")||Oe.has("EXT_color_buffer_float")?Hi:mn,minFilter:Yn,samples:4,stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:qe.workingColorSpace}));const Q=h.state.transmissionRenderTarget[k.id],se=k.viewport||C;Q.setSize(se.z*E.transmissionResolutionScale,se.w*E.transmissionResolutionScale);const he=E.getRenderTarget();E.setRenderTarget(Q),E.getClearColor(K),j=E.getClearAlpha(),j<1&&E.setClearColor(16777215,.5),E.clear(),He&&Ee.render(B);const me=E.toneMapping;E.toneMapping=An;const Ae=k.viewport;if(k.viewport!==void 0&&(k.viewport=void 0),h.setupLightsView(k),te===!0&&ee.setGlobalState(E.clippingPlanes,k),qi(_,B,k),M.updateMultisampleRenderTarget(Q),M.updateRenderTargetMipmap(Q),Oe.has("WEBGL_multisampled_render_to_texture")===!1){let Re=!1;for(let Se=0,Ge=D.length;Se<Ge;Se++){const $e=D[Se],lt=$e.object,rt=$e.geometry,Xe=$e.material,Me=$e.group;if(Xe.side===hn&&lt.layers.test(k.layers)){const vt=Xe.side;Xe.side=wt,Xe.needsUpdate=!0,Yo(lt,B,k,rt,Xe,Me),Xe.side=vt,Xe.needsUpdate=!0,Re=!0}}Re===!0&&(M.updateMultisampleRenderTarget(Q),M.updateRenderTargetMipmap(Q))}E.setRenderTarget(he),E.setClearColor(K,j),Ae!==void 0&&(k.viewport=Ae),E.toneMapping=me}function qi(_,D,B){const k=D.isScene===!0?D.overrideMaterial:null;for(let I=0,Q=_.length;I<Q;I++){const se=_[I],he=se.object,me=se.geometry,Ae=k===null?se.material:k,Re=se.group;he.layers.test(B.layers)&&Yo(he,D,B,me,Ae,Re)}}function Yo(_,D,B,k,I,Q){_.onBeforeRender(E,D,B,k,I,Q),_.modelViewMatrix.multiplyMatrices(B.matrixWorldInverse,_.matrixWorld),_.normalMatrix.getNormalMatrix(_.modelViewMatrix),I.onBeforeRender(E,D,B,k,_,Q),I.transparent===!0&&I.side===hn&&I.forceSinglePass===!1?(I.side=wt,I.needsUpdate=!0,E.renderBufferDirect(B,D,k,I,_,Q),I.side=wn,I.needsUpdate=!0,E.renderBufferDirect(B,D,k,I,_,Q),I.side=hn):E.renderBufferDirect(B,D,k,I,_,Q),_.onAfterRender(E,D,B,k,I,Q)}function Yi(_,D,B){D.isScene!==!0&&(D=it);const k=ve.get(_),I=h.state.lights,Q=h.state.shadowsArray,se=I.state.version,he=_e.getParameters(_,I.state,Q,D,B),me=_e.getProgramCacheKey(he);let Ae=k.programs;k.environment=_.isMeshStandardMaterial?D.environment:null,k.fog=D.fog,k.envMap=(_.isMeshStandardMaterial?O:g).get(_.envMap||k.environment),k.envMapRotation=k.environment!==null&&_.envMap===null?D.environmentRotation:_.envMapRotation,Ae===void 0&&(_.addEventListener("dispose",Ce),Ae=new Map,k.programs=Ae);let Re=Ae.get(me);if(Re!==void 0){if(k.currentProgram===Re&&k.lightsStateVersion===se)return Ko(_,he),Re}else he.uniforms=_e.getUniforms(_),_.onBeforeCompile(he,E),Re=_e.acquireProgram(he,me),Ae.set(me,Re),k.uniforms=he.uniforms;const Se=k.uniforms;return(!_.isShaderMaterial&&!_.isRawShaderMaterial||_.clipping===!0)&&(Se.clippingPlanes=ee.uniform),Ko(_,he),k.needsLights=tl(_),k.lightsStateVersion=se,k.needsLights&&(Se.ambientLightColor.value=I.state.ambient,Se.lightProbe.value=I.state.probe,Se.directionalLights.value=I.state.directional,Se.directionalLightShadows.value=I.state.directionalShadow,Se.spotLights.value=I.state.spot,Se.spotLightShadows.value=I.state.spotShadow,Se.rectAreaLights.value=I.state.rectArea,Se.ltc_1.value=I.state.rectAreaLTC1,Se.ltc_2.value=I.state.rectAreaLTC2,Se.pointLights.value=I.state.point,Se.pointLightShadows.value=I.state.pointShadow,Se.hemisphereLights.value=I.state.hemi,Se.directionalShadowMap.value=I.state.directionalShadowMap,Se.directionalShadowMatrix.value=I.state.directionalShadowMatrix,Se.spotShadowMap.value=I.state.spotShadowMap,Se.spotLightMatrix.value=I.state.spotLightMatrix,Se.spotLightMap.value=I.state.spotLightMap,Se.pointShadowMap.value=I.state.pointShadowMap,Se.pointShadowMatrix.value=I.state.pointShadowMatrix),k.currentProgram=Re,k.uniformsList=null,Re}function $o(_){if(_.uniformsList===null){const D=_.currentProgram.getUniforms();_.uniformsList=Rs.seqWithValue(D.seq,_.uniforms)}return _.uniformsList}function Ko(_,D){const B=ve.get(_);B.outputColorSpace=D.outputColorSpace,B.batching=D.batching,B.batchingColor=D.batchingColor,B.instancing=D.instancing,B.instancingColor=D.instancingColor,B.instancingMorph=D.instancingMorph,B.skinning=D.skinning,B.morphTargets=D.morphTargets,B.morphNormals=D.morphNormals,B.morphColors=D.morphColors,B.morphTargetsCount=D.morphTargetsCount,B.numClippingPlanes=D.numClippingPlanes,B.numIntersection=D.numClipIntersection,B.vertexAlphas=D.vertexAlphas,B.vertexTangents=D.vertexTangents,B.toneMapping=D.toneMapping}function Qc(_,D,B,k,I){D.isScene!==!0&&(D=it),M.resetTextureUnits();const Q=D.fog,se=k.isMeshStandardMaterial?D.environment:null,he=F===null?E.outputColorSpace:F.isXRRenderTarget===!0?F.texture.colorSpace:Ti,me=(k.isMeshStandardMaterial?O:g).get(k.envMap||se),Ae=k.vertexColors===!0&&!!B.attributes.color&&B.attributes.color.itemSize===4,Re=!!B.attributes.tangent&&(!!k.normalMap||k.anisotropy>0),Se=!!B.morphAttributes.position,Ge=!!B.morphAttributes.normal,$e=!!B.morphAttributes.color;let lt=An;k.toneMapped&&(F===null||F.isXRRenderTarget===!0)&&(lt=E.toneMapping);const rt=B.morphAttributes.position||B.morphAttributes.normal||B.morphAttributes.color,Xe=rt!==void 0?rt.length:0,Me=ve.get(k),vt=h.state.lights;if(te===!0&&(ge===!0||_!==x)){const Et=_===x&&k.id===S;ee.setState(k,_,Et)}let Ke=!1;k.version===Me.__version?(Me.needsLights&&Me.lightsStateVersion!==vt.state.version||Me.outputColorSpace!==he||I.isBatchedMesh&&Me.batching===!1||!I.isBatchedMesh&&Me.batching===!0||I.isBatchedMesh&&Me.batchingColor===!0&&I.colorTexture===null||I.isBatchedMesh&&Me.batchingColor===!1&&I.colorTexture!==null||I.isInstancedMesh&&Me.instancing===!1||!I.isInstancedMesh&&Me.instancing===!0||I.isSkinnedMesh&&Me.skinning===!1||!I.isSkinnedMesh&&Me.skinning===!0||I.isInstancedMesh&&Me.instancingColor===!0&&I.instanceColor===null||I.isInstancedMesh&&Me.instancingColor===!1&&I.instanceColor!==null||I.isInstancedMesh&&Me.instancingMorph===!0&&I.morphTexture===null||I.isInstancedMesh&&Me.instancingMorph===!1&&I.morphTexture!==null||Me.envMap!==me||k.fog===!0&&Me.fog!==Q||Me.numClippingPlanes!==void 0&&(Me.numClippingPlanes!==ee.numPlanes||Me.numIntersection!==ee.numIntersection)||Me.vertexAlphas!==Ae||Me.vertexTangents!==Re||Me.morphTargets!==Se||Me.morphNormals!==Ge||Me.morphColors!==$e||Me.toneMapping!==lt||Me.morphTargetsCount!==Xe)&&(Ke=!0):(Ke=!0,Me.__version=k.version);let kt=Me.currentProgram;Ke===!0&&(kt=Yi(k,D,I));let Zn=!1,Ct=!1,Ci=!1;const nt=kt.getUniforms(),It=Me.uniforms;if(ye.useProgram(kt.program)&&(Zn=!0,Ct=!0,Ci=!0),k.id!==S&&(S=k.id,Ct=!0),Zn||x!==_){ye.buffers.depth.getReversed()?(oe.copy(_.projectionMatrix),Jh(oe),Qh(oe),nt.setValue(A,"projectionMatrix",oe)):nt.setValue(A,"projectionMatrix",_.projectionMatrix),nt.setValue(A,"viewMatrix",_.matrixWorldInverse);const bt=nt.map.cameraPosition;bt!==void 0&&bt.setValue(A,we.setFromMatrixPosition(_.matrixWorld)),Be.logarithmicDepthBuffer&&nt.setValue(A,"logDepthBufFC",2/(Math.log(_.far+1)/Math.LN2)),(k.isMeshPhongMaterial||k.isMeshToonMaterial||k.isMeshLambertMaterial||k.isMeshBasicMaterial||k.isMeshStandardMaterial||k.isShaderMaterial)&&nt.setValue(A,"isOrthographic",_.isOrthographicCamera===!0),x!==_&&(x=_,Ct=!0,Ci=!0)}if(I.isSkinnedMesh){nt.setOptional(A,I,"bindMatrix"),nt.setOptional(A,I,"bindMatrixInverse");const Et=I.skeleton;Et&&(Et.boneTexture===null&&Et.computeBoneTexture(),nt.setValue(A,"boneTexture",Et.boneTexture,M))}I.isBatchedMesh&&(nt.setOptional(A,I,"batchingTexture"),nt.setValue(A,"batchingTexture",I._matricesTexture,M),nt.setOptional(A,I,"batchingIdTexture"),nt.setValue(A,"batchingIdTexture",I._indirectTexture,M),nt.setOptional(A,I,"batchingColorTexture"),I._colorsTexture!==null&&nt.setValue(A,"batchingColorTexture",I._colorsTexture,M));const Ut=B.morphAttributes;if((Ut.position!==void 0||Ut.normal!==void 0||Ut.color!==void 0)&&be.update(I,B,kt),(Ct||Me.receiveShadow!==I.receiveShadow)&&(Me.receiveShadow=I.receiveShadow,nt.setValue(A,"receiveShadow",I.receiveShadow)),k.isMeshGouraudMaterial&&k.envMap!==null&&(It.envMap.value=me,It.flipEnvMap.value=me.isCubeTexture&&me.isRenderTargetTexture===!1?-1:1),k.isMeshStandardMaterial&&k.envMap===null&&D.environment!==null&&(It.envMapIntensity.value=D.environmentIntensity),Ct&&(nt.setValue(A,"toneMappingExposure",E.toneMappingExposure),Me.needsLights&&el(It,Ci),Q&&k.fog===!0&&ae.refreshFogUniforms(It,Q),ae.refreshMaterialUniforms(It,k,V,J,h.state.transmissionRenderTarget[_.id]),Rs.upload(A,$o(Me),It,M)),k.isShaderMaterial&&k.uniformsNeedUpdate===!0&&(Rs.upload(A,$o(Me),It,M),k.uniformsNeedUpdate=!1),k.isSpriteMaterial&&nt.setValue(A,"center",I.center),nt.setValue(A,"modelViewMatrix",I.modelViewMatrix),nt.setValue(A,"normalMatrix",I.normalMatrix),nt.setValue(A,"modelMatrix",I.matrixWorld),k.isShaderMaterial||k.isRawShaderMaterial){const Et=k.uniformsGroups;for(let bt=0,zs=Et.length;bt<zs;bt++){const In=Et[bt];L.update(In,kt),L.bind(In,kt)}}return kt}function el(_,D){_.ambientLightColor.needsUpdate=D,_.lightProbe.needsUpdate=D,_.directionalLights.needsUpdate=D,_.directionalLightShadows.needsUpdate=D,_.pointLights.needsUpdate=D,_.pointLightShadows.needsUpdate=D,_.spotLights.needsUpdate=D,_.spotLightShadows.needsUpdate=D,_.rectAreaLights.needsUpdate=D,_.hemisphereLights.needsUpdate=D}function tl(_){return _.isMeshLambertMaterial||_.isMeshToonMaterial||_.isMeshPhongMaterial||_.isMeshStandardMaterial||_.isShadowMaterial||_.isShaderMaterial&&_.lights===!0}this.getActiveCubeFace=function(){return P},this.getActiveMipmapLevel=function(){return R},this.getRenderTarget=function(){return F},this.setRenderTargetTextures=function(_,D,B){ve.get(_.texture).__webglTexture=D,ve.get(_.depthTexture).__webglTexture=B;const k=ve.get(_);k.__hasExternalTextures=!0,k.__autoAllocateDepthBuffer=B===void 0,k.__autoAllocateDepthBuffer||Oe.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),k.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(_,D){const B=ve.get(_);B.__webglFramebuffer=D,B.__useDefaultFramebuffer=D===void 0};const nl=A.createFramebuffer();this.setRenderTarget=function(_,D=0,B=0){F=_,P=D,R=B;let k=!0,I=null,Q=!1,se=!1;if(_){const me=ve.get(_);if(me.__useDefaultFramebuffer!==void 0)ye.bindFramebuffer(A.FRAMEBUFFER,null),k=!1;else if(me.__webglFramebuffer===void 0)M.setupRenderTarget(_);else if(me.__hasExternalTextures)M.rebindTextures(_,ve.get(_.texture).__webglTexture,ve.get(_.depthTexture).__webglTexture);else if(_.depthBuffer){const Se=_.depthTexture;if(me.__boundDepthTexture!==Se){if(Se!==null&&ve.has(Se)&&(_.width!==Se.image.width||_.height!==Se.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");M.setupDepthRenderbuffer(_)}}const Ae=_.texture;(Ae.isData3DTexture||Ae.isDataArrayTexture||Ae.isCompressedArrayTexture)&&(se=!0);const Re=ve.get(_).__webglFramebuffer;_.isWebGLCubeRenderTarget?(Array.isArray(Re[D])?I=Re[D][B]:I=Re[D],Q=!0):_.samples>0&&M.useMultisampledRTT(_)===!1?I=ve.get(_).__webglMultisampledFramebuffer:Array.isArray(Re)?I=Re[B]:I=Re,C.copy(_.viewport),W.copy(_.scissor),z=_.scissorTest}else C.copy(xe).multiplyScalar(V).floor(),W.copy(Ie).multiplyScalar(V).floor(),z=Qe;if(B!==0&&(I=nl),ye.bindFramebuffer(A.FRAMEBUFFER,I)&&k&&ye.drawBuffers(_,I),ye.viewport(C),ye.scissor(W),ye.setScissorTest(z),Q){const me=ve.get(_.texture);A.framebufferTexture2D(A.FRAMEBUFFER,A.COLOR_ATTACHMENT0,A.TEXTURE_CUBE_MAP_POSITIVE_X+D,me.__webglTexture,B)}else if(se){const me=ve.get(_.texture),Ae=D;A.framebufferTextureLayer(A.FRAMEBUFFER,A.COLOR_ATTACHMENT0,me.__webglTexture,B,Ae)}else if(_!==null&&B!==0){const me=ve.get(_.texture);A.framebufferTexture2D(A.FRAMEBUFFER,A.COLOR_ATTACHMENT0,A.TEXTURE_2D,me.__webglTexture,B)}S=-1},this.readRenderTargetPixels=function(_,D,B,k,I,Q,se){if(!(_&&_.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let he=ve.get(_).__webglFramebuffer;if(_.isWebGLCubeRenderTarget&&se!==void 0&&(he=he[se]),he){ye.bindFramebuffer(A.FRAMEBUFFER,he);try{const me=_.texture,Ae=me.format,Re=me.type;if(!Be.textureFormatReadable(Ae)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Be.textureTypeReadable(Re)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}D>=0&&D<=_.width-k&&B>=0&&B<=_.height-I&&A.readPixels(D,B,k,I,Le.convert(Ae),Le.convert(Re),Q)}finally{const me=F!==null?ve.get(F).__webglFramebuffer:null;ye.bindFramebuffer(A.FRAMEBUFFER,me)}}},this.readRenderTargetPixelsAsync=async function(_,D,B,k,I,Q,se){if(!(_&&_.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let he=ve.get(_).__webglFramebuffer;if(_.isWebGLCubeRenderTarget&&se!==void 0&&(he=he[se]),he){const me=_.texture,Ae=me.format,Re=me.type;if(!Be.textureFormatReadable(Ae))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Be.textureTypeReadable(Re))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(D>=0&&D<=_.width-k&&B>=0&&B<=_.height-I){ye.bindFramebuffer(A.FRAMEBUFFER,he);const Se=A.createBuffer();A.bindBuffer(A.PIXEL_PACK_BUFFER,Se),A.bufferData(A.PIXEL_PACK_BUFFER,Q.byteLength,A.STREAM_READ),A.readPixels(D,B,k,I,Le.convert(Ae),Le.convert(Re),0);const Ge=F!==null?ve.get(F).__webglFramebuffer:null;ye.bindFramebuffer(A.FRAMEBUFFER,Ge);const $e=A.fenceSync(A.SYNC_GPU_COMMANDS_COMPLETE,0);return A.flush(),await Zh(A,$e,4),A.bindBuffer(A.PIXEL_PACK_BUFFER,Se),A.getBufferSubData(A.PIXEL_PACK_BUFFER,0,Q),A.deleteBuffer(Se),A.deleteSync($e),Q}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(_,D=null,B=0){_.isTexture!==!0&&(pi("WebGLRenderer: copyFramebufferToTexture function signature has changed."),D=arguments[0]||null,_=arguments[1]);const k=Math.pow(2,-B),I=Math.floor(_.image.width*k),Q=Math.floor(_.image.height*k),se=D!==null?D.x:0,he=D!==null?D.y:0;M.setTexture2D(_,0),A.copyTexSubImage2D(A.TEXTURE_2D,B,0,0,se,he,I,Q),ye.unbindTexture()};const il=A.createFramebuffer(),sl=A.createFramebuffer();this.copyTextureToTexture=function(_,D,B=null,k=null,I=0,Q=null){_.isTexture!==!0&&(pi("WebGLRenderer: copyTextureToTexture function signature has changed."),k=arguments[0]||null,_=arguments[1],D=arguments[2],Q=arguments[3]||0,B=null),Q===null&&(I!==0?(pi("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),Q=I,I=0):Q=0);let se,he,me,Ae,Re,Se,Ge,$e,lt;const rt=_.isCompressedTexture?_.mipmaps[Q]:_.image;if(B!==null)se=B.max.x-B.min.x,he=B.max.y-B.min.y,me=B.isBox3?B.max.z-B.min.z:1,Ae=B.min.x,Re=B.min.y,Se=B.isBox3?B.min.z:0;else{const Ut=Math.pow(2,-I);se=Math.floor(rt.width*Ut),he=Math.floor(rt.height*Ut),_.isDataArrayTexture?me=rt.depth:_.isData3DTexture?me=Math.floor(rt.depth*Ut):me=1,Ae=0,Re=0,Se=0}k!==null?(Ge=k.x,$e=k.y,lt=k.z):(Ge=0,$e=0,lt=0);const Xe=Le.convert(D.format),Me=Le.convert(D.type);let vt;D.isData3DTexture?(M.setTexture3D(D,0),vt=A.TEXTURE_3D):D.isDataArrayTexture||D.isCompressedArrayTexture?(M.setTexture2DArray(D,0),vt=A.TEXTURE_2D_ARRAY):(M.setTexture2D(D,0),vt=A.TEXTURE_2D),A.pixelStorei(A.UNPACK_FLIP_Y_WEBGL,D.flipY),A.pixelStorei(A.UNPACK_PREMULTIPLY_ALPHA_WEBGL,D.premultiplyAlpha),A.pixelStorei(A.UNPACK_ALIGNMENT,D.unpackAlignment);const Ke=A.getParameter(A.UNPACK_ROW_LENGTH),kt=A.getParameter(A.UNPACK_IMAGE_HEIGHT),Zn=A.getParameter(A.UNPACK_SKIP_PIXELS),Ct=A.getParameter(A.UNPACK_SKIP_ROWS),Ci=A.getParameter(A.UNPACK_SKIP_IMAGES);A.pixelStorei(A.UNPACK_ROW_LENGTH,rt.width),A.pixelStorei(A.UNPACK_IMAGE_HEIGHT,rt.height),A.pixelStorei(A.UNPACK_SKIP_PIXELS,Ae),A.pixelStorei(A.UNPACK_SKIP_ROWS,Re),A.pixelStorei(A.UNPACK_SKIP_IMAGES,Se);const nt=_.isDataArrayTexture||_.isData3DTexture,It=D.isDataArrayTexture||D.isData3DTexture;if(_.isDepthTexture){const Ut=ve.get(_),Et=ve.get(D),bt=ve.get(Ut.__renderTarget),zs=ve.get(Et.__renderTarget);ye.bindFramebuffer(A.READ_FRAMEBUFFER,bt.__webglFramebuffer),ye.bindFramebuffer(A.DRAW_FRAMEBUFFER,zs.__webglFramebuffer);for(let In=0;In<me;In++)nt&&(A.framebufferTextureLayer(A.READ_FRAMEBUFFER,A.COLOR_ATTACHMENT0,ve.get(_).__webglTexture,I,Se+In),A.framebufferTextureLayer(A.DRAW_FRAMEBUFFER,A.COLOR_ATTACHMENT0,ve.get(D).__webglTexture,Q,lt+In)),A.blitFramebuffer(Ae,Re,se,he,Ge,$e,se,he,A.DEPTH_BUFFER_BIT,A.NEAREST);ye.bindFramebuffer(A.READ_FRAMEBUFFER,null),ye.bindFramebuffer(A.DRAW_FRAMEBUFFER,null)}else if(I!==0||_.isRenderTargetTexture||ve.has(_)){const Ut=ve.get(_),Et=ve.get(D);ye.bindFramebuffer(A.READ_FRAMEBUFFER,il),ye.bindFramebuffer(A.DRAW_FRAMEBUFFER,sl);for(let bt=0;bt<me;bt++)nt?A.framebufferTextureLayer(A.READ_FRAMEBUFFER,A.COLOR_ATTACHMENT0,Ut.__webglTexture,I,Se+bt):A.framebufferTexture2D(A.READ_FRAMEBUFFER,A.COLOR_ATTACHMENT0,A.TEXTURE_2D,Ut.__webglTexture,I),It?A.framebufferTextureLayer(A.DRAW_FRAMEBUFFER,A.COLOR_ATTACHMENT0,Et.__webglTexture,Q,lt+bt):A.framebufferTexture2D(A.DRAW_FRAMEBUFFER,A.COLOR_ATTACHMENT0,A.TEXTURE_2D,Et.__webglTexture,Q),I!==0?A.blitFramebuffer(Ae,Re,se,he,Ge,$e,se,he,A.COLOR_BUFFER_BIT,A.NEAREST):It?A.copyTexSubImage3D(vt,Q,Ge,$e,lt+bt,Ae,Re,se,he):A.copyTexSubImage2D(vt,Q,Ge,$e,Ae,Re,se,he);ye.bindFramebuffer(A.READ_FRAMEBUFFER,null),ye.bindFramebuffer(A.DRAW_FRAMEBUFFER,null)}else It?_.isDataTexture||_.isData3DTexture?A.texSubImage3D(vt,Q,Ge,$e,lt,se,he,me,Xe,Me,rt.data):D.isCompressedArrayTexture?A.compressedTexSubImage3D(vt,Q,Ge,$e,lt,se,he,me,Xe,rt.data):A.texSubImage3D(vt,Q,Ge,$e,lt,se,he,me,Xe,Me,rt):_.isDataTexture?A.texSubImage2D(A.TEXTURE_2D,Q,Ge,$e,se,he,Xe,Me,rt.data):_.isCompressedTexture?A.compressedTexSubImage2D(A.TEXTURE_2D,Q,Ge,$e,rt.width,rt.height,Xe,rt.data):A.texSubImage2D(A.TEXTURE_2D,Q,Ge,$e,se,he,Xe,Me,rt);A.pixelStorei(A.UNPACK_ROW_LENGTH,Ke),A.pixelStorei(A.UNPACK_IMAGE_HEIGHT,kt),A.pixelStorei(A.UNPACK_SKIP_PIXELS,Zn),A.pixelStorei(A.UNPACK_SKIP_ROWS,Ct),A.pixelStorei(A.UNPACK_SKIP_IMAGES,Ci),Q===0&&D.generateMipmaps&&A.generateMipmap(vt),ye.unbindTexture()},this.copyTextureToTexture3D=function(_,D,B=null,k=null,I=0){return _.isTexture!==!0&&(pi("WebGLRenderer: copyTextureToTexture3D function signature has changed."),B=arguments[0]||null,k=arguments[1]||null,_=arguments[2],D=arguments[3],I=arguments[4]||0),pi('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(_,D,B,k,I)},this.initRenderTarget=function(_){ve.get(_).__webglFramebuffer===void 0&&M.setupRenderTarget(_)},this.initTexture=function(_){_.isCubeTexture?M.setTextureCube(_,0):_.isData3DTexture?M.setTexture3D(_,0):_.isDataArrayTexture||_.isCompressedArrayTexture?M.setTexture2DArray(_,0):M.setTexture2D(_,0),ye.unbindTexture()},this.resetState=function(){P=0,R=0,F=null,ye.reset(),et.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return fn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorspace=qe._getDrawingBufferColorSpace(e),t.unpackColorSpace=qe._getUnpackColorSpace()}}class Kc{constructor(e){this.shapeType=e.shapeType||"cube",this.size=e.size||this.getDefaultSize(this.shapeType),this.position=e.position||new N(e.x,e.y,e.z),this.rotation=new N(0,0,0),this.friction=e.friction||.5,this.isCollidable=e.isCollidable!==void 0?e.isCollidable:!0,this.shape=null,this.boundingBox=null,this.id=e.id||null}getDefaultSize(e){switch(e){case"cube":return{width:1,height:1,depth:1};case"sphere":return{radius:1};default:throw new Error(`Shape "${e}" is not supported.`)}}update(){throw new Error("Method 'update' must be implemented by subclasses.")}}class vg{constructor(){this._previousTime=0,this._currentTime=0,this._startTime=Mr(),this._delta=0,this._elapsed=0,this._timescale=1,this._usePageVisibilityAPI=typeof document<"u"&&document.hidden!==void 0,this._usePageVisibilityAPI===!0&&(this._pageVisibilityHandler=xg.bind(this),document.addEventListener("visibilitychange",this._pageVisibilityHandler,!1))}getDelta(){return this._delta/1e3}getElapsed(){return this._elapsed/1e3}getTimescale(){return this._timescale}setTimescale(e){return this._timescale=e,this}reset(){return this._currentTime=Mr()-this._startTime,this}dispose(){return this._usePageVisibilityAPI===!0&&document.removeEventListener("visibilitychange",this._pageVisibilityHandler),this}update(e){return this._usePageVisibilityAPI===!0&&document.hidden===!0?this._delta=0:(this._previousTime=this._currentTime,this._currentTime=(e!==void 0?e:Mr())-this._startTime,this._delta=(this._currentTime-this._previousTime)*this._timescale,this._elapsed+=this._delta),this}}function Mr(){return performance.now()}function xg(){document.hidden===!1&&this.reset()}class jc extends Kc{constructor(e){super(e),this.position=this.position||new N,this.velocity=new N(0,0,0),this.acceleration=new N(0,0,0),this.appliedForces=new N(0,0,0),this.previousPosition=this.position.clone(),this.renderPosition=this.position.clone(),this.mass=e.mass||10,this.terminalVelocity=e.terminalVelocity||20,this.isGrounded=!1,this.timer=new vg,this.timer.setTimescale(1),this.accumulatedTime=0,this.fixedDelta=1/120,this.wishDir=new N(0,0,0),this.targetSpeed=50}accelerate(e,t,n,s,r){const a=t.clone().multiplyScalar(n).sub(e),c=s*r;return a.length()>c&&a.setLength(c),e.add(a)}applyGroundFriction(e,t,n){const s=e.length();if(s<.1)return new N(0,0,0);const r=s*t*n,o=Math.max(s-r,0);return e.clone().normalize().multiplyScalar(o)}applyGravity(e,t){return t+-50*e}updatePhysics(e){const t=this.velocity.clone();let n=new N(this.velocity.x,0,this.velocity.z),s=this.velocity.y;s=this.applyGravity(e,s),this.isGrounded?this.wishDir.lengthSq()>0?n=this.accelerate(n,this.wishDir,this.targetSpeed,50,e):n=this.applyGroundFriction(n,10,e):(this.wishDir.lengthSq()>0&&(n=this.accelerate(n,this.wishDir,this.targetSpeed,40,e)),n=this.applyGroundFriction(n,2,e)),this.velocity.set(n.x,s,n.z),this.velocity.y<-this.terminalVelocity&&(this.velocity.y=-this.terminalVelocity);const r=new N().addVectors(t,this.velocity).multiplyScalar(.5);this.position.add(r.multiplyScalar(e)),this.appliedForces.set(0,0,0)}resolveCollision(e){const t=e.boundingBox,n=this.boundingBox,s=this.calculateMTV(n,t);if(!s||s.length()<.01)return;const o=this.position.clone().sub(e.position).normalize(),a=s.dot(o)<0?s.negate():s;this.position.add(a);const c=a.clone().normalize();Math.abs(c.x)>Math.abs(c.y)&&Math.abs(c.x)>Math.abs(c.z)?this.velocity.x=0:Math.abs(c.y)>Math.abs(c.z)?(this.velocity.y=0,n.corners[0].y>t.corners[0].y&&(this.isGrounded=!0)):this.velocity.z=0}handleCollisions(e){const t=this.boundingBox.handleCollisions(e);if(t.length>0)for(const n of t)this.resolveCollision(n);else this.isGrounded=!1}calculateMTV(e,t){const n=e.getSeparatingAxes(e.corners,t.corners);let s=1/0,r=null;for(const o of n){let a=1/0,c=-1/0,l=1/0,u=-1/0;for(const f of e.corners){const m=f.dot(o);a=Math.min(a,m),c=Math.max(c,m)}for(const f of t.corners){const m=f.dot(o);l=Math.min(l,m),u=Math.max(u,m)}if(c<l||u<a)return null;const d=Math.min(c,u)-Math.max(a,l);d<s&&(s=d,r=o.clone().multiplyScalar(d))}return r}update(){for(this.timer.update(),this.accumulatedTime+=this.timer.getDelta();this.accumulatedTime>=this.fixedDelta;)this.previousPosition.copy(this.position),this.updatePhysics(this.fixedDelta),this.boundingBox&&typeof this.boundingBox.update=="function"&&this.boundingBox.update(),this.accumulatedTime-=this.fixedDelta;const e=this.accumulatedTime/this.fixedDelta;this.renderPosition.copy(this.previousPosition).lerp(this.position,e)}}class Zc{constructor(e){this.type=e.type,this.size=e.size,this.position=e.position||new N(0,0,0),console.log("Testing the configuration of the shape: "),console.log("Shape position: ",this.position),console.log("Shape size: ",this.size),this.mesh=zi.shapes[this.type](e),this.mesh.position.set(this.position.x,this.position.y,this.position.z),this.entity=null}translate(e,t,n){this.mesh.position.x+=e,this.mesh.position.y+=t,this.mesh.position.z+=n}scale(e,t,n){this.mesh.scale.x*=e,this.mesh.scale.y*=t,this.mesh.scale.z*=n}rotate(e,t,n){this.mesh.rotation.x+=e,this.mesh.rotation.y+=t,this.mesh.rotation.z+=n}attach(e){this.entity=e}update(){if(!this.entity){console.error("Shape is not attached to an entity.");return}if(this.mesh.position.set(0,0,0),this.entity.rotation&&this.mesh.rotation.set(this.entity.rotation.x,this.entity.rotation.y,this.entity.rotation.z),this.entity.size){const e=this.size;this.mesh.scale.set(this.entity.size.width/e.width,this.entity.size.height/e.height,this.entity.size.depth/e.depth)}this.mesh.position.set(this.entity.position.x,this.entity.position.y,this.entity.position.z)}}const Is=class Is{static registerShape(e,t){Is.shapes[e]=t}};Hs(Is,"shapes",{});let zi=Is;zi.registerShape("cube",i=>{const e=i.size,t=new wi(e.width,e.height,e.depth),n=new bu({color:i.color||16777215,roughness:.5,metalness:.5});return new qt(t,n)});zi.registerShape("sphere",i=>{const e=new zo(i.size.radius),t=new Bo({color:65280});return new qt(e,t)});class yg extends jc{constructor(e){super(e),this.camera=e.camera,this.targetPos=this.position,this.size={width:1,height:2,depth:1},this.health=100,this.inputs={},this.t=0}handleMovement(){if(++this.t>5){const e=this.camera;En.send_inputs(this.inputs,{quaternion:{x:e.quaternion.x,y:e.quaternion.y,z:e.quaternion.z,w:e.quaternion.w}}),this.inputs={},this.t=0}ft.pressed("W")&&(this.inputs.move_forward=!0),ft.pressed("S")&&(this.inputs.move_backward=!0),ft.pressed("A")&&(this.inputs.move_left=!0),ft.pressed("D")&&(this.inputs.move_right=!0),ft.pressed("Space")&&(this.inputs.jump=!0)}update(e){this.handleMovement(),this.position=this.targetPos}}class Sg extends jc{constructor(e){super(e),this.shape=e.shape||new Zc({type:"cube",size:this.size,position:this.position,color:11184810}),this.shape.mesh.castShadow=!0,this.shape.mesh.receiveShadow=!0,this.shape.attach(this),this.targetPos=this.position}update(){console.log("Testing: the opponent's update is being called."),this.shape.update(),this.position=this.targetPos}}class Mg extends Kc{constructor(e){super(e)}update(){this.shape.mesh&&(this.shape.mesh.position.copy(this.position),this.shape.mesh.rotation.set(this.rotation.x,this.rotation.y,this.rotation.z))}}class Eg extends Mg{constructor(e){super(e),console.log("Properties of the block: "),console.log("Size: ",this.size),console.log("Position: ",this.position),this.shape=e.shape||new Zc({type:"cube",size:this.size,position:this.position,color:11184810}),this.shape.mesh.castShadow=!0,this.shape.mesh.receiveShadow=!0,this.shape.attach(this),this.targetPos=this.position}update(){this.shape.update(),this.position=this.targetPos}}const di=new $t(0,0,0,"YXZ"),fi=new N,Tg={type:"change"},bg={type:"lock"},Ag={type:"unlock"},ec=Math.PI/2;class wg extends Uu{constructor(e,t=null){super(e,t),this.isLocked=!1,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.pointerSpeed=1,this._onMouseMove=Rg.bind(this),this._onPointerlockChange=Cg.bind(this),this._onPointerlockError=Pg.bind(this),this.domElement!==null&&this.connect()}connect(){this.domElement.ownerDocument.addEventListener("mousemove",this._onMouseMove),this.domElement.ownerDocument.addEventListener("pointerlockchange",this._onPointerlockChange),this.domElement.ownerDocument.addEventListener("pointerlockerror",this._onPointerlockError)}disconnect(){this.domElement.ownerDocument.removeEventListener("mousemove",this._onMouseMove),this.domElement.ownerDocument.removeEventListener("pointerlockchange",this._onPointerlockChange),this.domElement.ownerDocument.removeEventListener("pointerlockerror",this._onPointerlockError)}dispose(){this.disconnect()}getObject(){return console.warn("THREE.PointerLockControls: getObject() has been deprecated. Use controls.object instead."),this.object}getDirection(e){return e.set(0,0,-1).applyQuaternion(this.object.quaternion)}moveForward(e){if(this.enabled===!1)return;const t=this.object;fi.setFromMatrixColumn(t.matrix,0),fi.crossVectors(t.up,fi),t.position.addScaledVector(fi,e)}moveRight(e){if(this.enabled===!1)return;const t=this.object;fi.setFromMatrixColumn(t.matrix,0),t.position.addScaledVector(fi,e)}lock(){this.domElement.requestPointerLock()}unlock(){this.domElement.ownerDocument.exitPointerLock()}}function Rg(i){if(this.enabled===!1||this.isLocked===!1)return;const e=this.object;di.setFromQuaternion(e.quaternion),di.y-=i.movementX*.002*this.pointerSpeed,di.x-=i.movementY*.002*this.pointerSpeed,di.x=Math.max(ec-this.maxPolarAngle,Math.min(ec-this.minPolarAngle,di.x)),e.quaternion.setFromEuler(di),this.dispatchEvent(Tg)}function Cg(){this.domElement.ownerDocument.pointerLockElement===this.domElement?(this.dispatchEvent(bg),this.isLocked=!0):(this.dispatchEvent(Ag),this.isLocked=!1)}function Pg(){console.error("THREE.PointerLockControls: Unable to use Pointer Lock API")}const w={ctx:ln.getContext("2d"),fillStyle:"rgb(0, 0, 0)",strokeStyle:"rgb(0, 0, 0)",lineWidth:1,fontSize:20,fontStyle:"Arial",textAlignH:"left",textAlignV:"top",width:window.innerWidth,height:window.innerHeight,fill(i,e,t){this.fillStyle=`rgb(${i}, ${e}, ${t})`},stroke(i,e,t){this.strokeStyle=`rgb(${i}, ${e}, ${t})`},strokeWeight(i){this.lineWidth=i},textSize(i){this.fontSize=i},textStyle(i="Arial"){this.fontStyle=i},textAlign(i="left",e="top"){const t=["left","center","right"],n={top:"top",middle:"middle",bottom:"bottom",alphabetic:"alphabetic"};this.textAlignH=t.includes(i)?i:"left",this.textAlignV=n[e]||"alphabetic"},rect(i,e,t,n,s=0){this.ctx.fillStyle=this.fillStyle,this.ctx.strokeStyle=this.strokeStyle,this.ctx.lineWidth=this.lineWidth,this.ctx.beginPath(),s>0?(this.ctx.moveTo(i+s,e),this.ctx.lineTo(i+t-s,e),this.ctx.quadraticCurveTo(i+t,e,i+t,e+s),this.ctx.lineTo(i+t,e+n-s),this.ctx.quadraticCurveTo(i+t,e+n,i+t-s,e+n),this.ctx.lineTo(i+s,e+n),this.ctx.quadraticCurveTo(i,e+n,i,e+n-s),this.ctx.lineTo(i,e+s),this.ctx.quadraticCurveTo(i,e,i+s,e)):this.ctx.rect(i,e,t,n),this.ctx.fill(),this.ctx.stroke()},ellipse(i,e,t,n){this.ctx.fillStyle=this.fillStyle,this.ctx.strokeStyle=this.strokeStyle,this.ctx.lineWidth=this.lineWidth,this.ctx.beginPath(),this.ctx.ellipse(i,e,t/2,n/2,0,0,Math.PI*2),this.ctx.fill(),this.ctx.stroke()},text(i,e,t){this.ctx.fillStyle=this.fillStyle,this.ctx.font=`${this.fontSize}px ${this.fontStyle}`,this.ctx.textAlign=this.textAlignH,this.ctx.textBaseline=this.textAlignV,this.fontSize,this.ctx.fillText(i,e,t)}};let Vn,Gn,un;class Lg{constructor(){this.finished_loading=!1,this.clock=new Iu,this.pointerLockControls=null,this.socketID=null,this.entities=[],this.entity_dict={},this.player=null}async setup(){this.entities=[];const e=new Lu(4210752);Vn.add(e),Vn.background=new Ye(8900331);const t=new Pu(16777215,.5);t.position.set(0,10,5).normalize(),Vn.add(t),Gn=new ut(75,window.innerWidth/window.innerHeight,.01,2e3),En.request_initial_game_state();const n=await En.get_initial_game_state();console.log("Number of players: ",n.players),n.players.forEach(s=>{const r=s.state.position,o=s.state.size;if(s.id===En.get_socket_id()){const a=new yg({position:new N(r.x,r.y,r.z),camera:Gn,id:s.id});this.entities.push(a),this.entity_dict[s.id]=a,this.player=a}else{const a=new Sg({position:new N(r.x,r.y,r.z),id:s.id,size:{width:o.width*2,height:o.height*2,depth:o.depth*2}});this.entities.push(a),this.entity_dict[s.id]=a}}),n.blocks.forEach(s=>{const r=s.state.position,o=s.state.size,a=new Eg({position:new N(r.x,r.y,r.z),size:{width:o.width*2,height:o.height*2,depth:o.depth*2},shapeType:"cube",isCollidable:!0,id:s.id});this.entities.push(a),this.entity_dict[s.id]=a}),this.camera={target:this.player},Gn.position.copy(this.player.position).add(new N(0,1.5,0)),this.pointerLockControls=new wg(Gn,un.domElement),Vn.add(this.pointerLockControls.object),un.domElement.addEventListener("click",()=>{un.domElement.requestPointerLock()}),this.entities.forEach(s=>{s.shape&&s.shape.mesh&&Vn.add(s.shape.mesh)}),this.updateCameraPosition(),this.finished_loading=!0}updateCameraPosition(){const e=this.camera.target,t=e.state==="crouching"?.15:.98;Gn.position.copy(e.position).add(new N(0,t,0))}updateGameEntities(e){const t=this.entity_dict;e.forEach(n=>{const s=n.state,r=t[n.id];r.targetPos=new N(s.position.x,s.position.y,s.position.z)})}play(){this.clock.getDelta(),this.entities.forEach(e=>{e.update(this.entities)}),this.updateCameraPosition(),un.render(Vn,Gn),En.receive_game_state(this.updateGameEntities.bind(this))}}const vs=new Lg,Dg={name:"Play",init:function(){Vn=new Pn,Gn=new ut(75,window.innerWidth/window.innerHeight,.1,2e3),un=new Ln,un.setSize(window.innerWidth,window.innerHeight),un.shadowMap.enabled=!0,document.getElementById("threed-canvas").innerHTML="",document.getElementById("threed-canvas").appendChild(un.domElement),un.domElement.addEventListener("click",()=>{vs.pointerLockControls.lock()}),document.addEventListener("pointerlockerror",()=>{console.error("Error while attempting to lock pointer")}),vs.setup()},display:function(){vs.finished_loading?vs.play():console.log("Game is loading...")},buttons:[new _t({x:65,y:35,width:100,height:50,display:function(){w.stroke(255,255,255),w.strokeWeight(5),this.isInside(We,this)?(w.fill(175,175,175),We.setCursor("pointer")):w.fill(200,200,200,200),w.rect(this.x,this.y,this.width,this.height,10),w.textSize(20),w.textStyle("Arial"),w.fill(0,0,0),w.textAlign("center","bottom"),w.text("Home",this.x+this.width/2,this.y+this.height-15)},onClick:function(){ze.createTransition("menu"),En.disconnect()}})]};let Er;function Ig(i){let e=[];return i=="guest-view"?(e.push(new _t({x:w.width/2-60,y:300,width:100,height:50,display:function(){w.stroke(255,255,255),w.strokeWeight(5),this.isInside(We,this)?(w.fill(175,175,175),We.setCursor("pointer")):w.fill(200,200,200,200),w.rect(this.x,this.y,this.width,this.height,10),w.textSize(20),w.textStyle("Arial"),w.fill(0,0,0),w.textAlign("center","bottom"),w.text("Play",this.x+this.width/2,this.y+this.height-15)},onClick:function(){ze.createTransition("arenas")}})),e.push(new _t({x:w.width/2-60,y:400,width:100,height:50,display:function(){w.stroke(255,255,255),w.strokeWeight(5),this.isInside(We,this)?(w.fill(175,175,175),We.setCursor("pointer")):w.fill(200,200,200,200),w.rect(this.x,this.y,this.width,this.height,10),w.textSize(20),w.textStyle("Arial"),w.fill(0,0,0),w.textAlign("center","bottom"),w.text("Signup",this.x+this.width/2,this.y+this.height-15)},onClick:function(){ze.createTransition("signup")}})),e.push(new _t({x:w.width/2-60,y:500,width:100,height:50,display:function(){w.stroke(255,255,255),w.strokeWeight(5),this.isInside(We,this)?(w.fill(175,175,175),We.setCursor("pointer")):w.fill(200,200,200,200),w.rect(this.x,this.y,this.width,this.height,10),w.textSize(20),w.textStyle("Arial"),w.fill(0,0,0),w.textAlign("center","bottom"),w.text("Login",this.x+this.width/2,this.y+this.height-15)},onClick:function(){ze.createTransition("login")}}))):(e.push(new _t({x:w.width/2-60,y:300,width:100,height:50,display:function(){w.stroke(255,255,255),w.strokeWeight(5),this.isInside(We,this)?(w.fill(175,175,175),We.setCursor("pointer")):w.fill(200,200,200,200),w.rect(this.x,this.y,this.width,this.height,10),w.textSize(20),w.textStyle("Arial"),w.fill(0,0,0),w.textAlign("center","bottom"),w.text("Play",this.x+this.width/2,this.y+this.height-15)},onClick:function(){ze.createTransition("arenas")}})),e.push(new _t({x:w.width/2-60,y:400,width:100,height:50,display:function(){w.stroke(255,255,255),w.strokeWeight(5),this.isInside(We,this)?(w.fill(175,175,175),We.setCursor("pointer")):w.fill(200,200,200,200),w.rect(this.x,this.y,this.width,this.height,10),w.textSize(20),w.textStyle("Arial"),w.fill(0,0,0),w.textAlign("center","bottom"),w.text("Profile",this.x+this.width/2,this.y+this.height-15)},onClick:function(){ze.createTransition("personal-profile")}})),e.push(new _t({x:w.width/2-60,y:500,width:100,height:50,display:function(){w.stroke(255,255,255),w.strokeWeight(5),this.isInside(We,this)?(w.fill(175,175,175),We.setCursor("pointer")):w.fill(200,200,200,200),w.rect(this.x,this.y,this.width,this.height,10),w.textSize(20),w.textStyle("Arial"),w.fill(0,0,0),w.textAlign("center","bottom"),w.text("Settings",this.x+this.width/2,this.y+this.height-15)},onClick:function(){ze.createTransition("settings")}})),e.push(new _t({x:w.width/2-60,y:600,width:100,height:50,display:function(){w.stroke(255,255,255),w.strokeWeight(5),this.isInside(We,this)?(w.fill(175,175,175),We.setCursor("pointer")):w.fill(200,200,200,200),w.rect(this.x,this.y,this.width,this.height,10),w.textSize(20),w.textStyle("Arial"),w.fill(0,0,0),w.textAlign("center","bottom"),w.text("Logout",this.x+this.width/2,this.y+this.height-15)},onClick:async function(){await sendPostRequest("logout")?ze.createTransition("menu"):alert("Error Logging Out.")}}))),e}const Ug={name:"menu",init:async function(){new Pn,new ut(75,window.innerWidth/window.innerHeight,.1,1e3),Er=new Ln,Er.setSize(window.innerWidth,window.innerHeight),document.getElementById("threed-canvas").innerHTML="",document.getElementById("threed-canvas").appendChild(Er.domElement),w.width=window.innerWidth,w.height=window.innerHeight,ze.scenes.menu.buttons=Ig(ze.user==null?"guest-view":"personal-view")},display:function(){w.fill(0,0,0),w.textSize(50),w.textAlign("center","top"),w.text("Paintball.io",w.width/2,150)},buttons:[]};let Tr;const Ng={name:"Login",init:function(){new Pn,new ut(75,window.innerWidth/window.innerHeight,.1,1e3),Tr=new Ln,Tr.setSize(window.innerWidth,window.innerHeight),document.getElementById("threed-canvas").innerHTML="",document.getElementById("threed-canvas").appendChild(Tr.domElement),w.width=window.innerWidth,w.height=window.innerHeight,document.querySelector(".html-content").innerHTML+=`
...
`;const i=document.getElementById("error"),e=document.getElementById("message"),t=document.getElementById("registerForm"),n=document.getElementById("verificationForm"),s=document.getElementById("login-button"),r=document.getElementById("resend-verification");s.addEventListener("click",function(){ze.createTransition("login")}),i.style.display="none",e.style.display="none",n.style.display="none",r.style.display="none",s.style.display="none",t.addEventListener("submit",async function(o){o.preventDefault();const a=t.querySelector("#registerForm button[type='submit']");a.disabled=!0,a.innerText="Registering...";try{const c=new FormData(this),u=await(await fetch("/register",{method:"POST",body:JSON.stringify(Object.fromEntries(c)),headers:{"Content-Type":"application/json"}})).json();i.style.display="none",e.style.display="none",u.error&&(i.innerText=u.error,i.style.display="block"),u.message&&(e.style.display="block",e.innerText=u.message,t.style.display="none",n.style.display="block")}catch(c){console.error("Login request failed:",c)}finally{a.disabled=!1,a.innerText="Sign Up"}}),n.addEventListener("submit",async function(o){o.preventDefault();const a=document.getElementById("verificationCode").value,l=await(await fetch("/verify",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({verificationCode:a})})).json();i.style.display="none",e.style.display="none",l.error&&(i.innerText=l.error,i.style.display="block",l.err_code&&l.err_code==="invalid_code"&&(r.style.display="block",document.getElementById("verificationCode").value="")),l.message&&(e.style.display="block",e.innerText=l.message,n.style.display="none",r.style.display="none",s.style.display="block")}),r.addEventListener("submit",async function(o){o.preventDefault();const a=new FormData(this),l=await(await fetch("/resend-verification",{method:"POST",body:JSON.stringify(Object.fromEntries(a)),headers:{"Content-Type":"application/json"}})).json();i.style.display="none",e.style.display="none",l.error&&(i.innerText=l.error,i.style.display="block"),l.message&&(e.style.display="block",e.innerText=l.message,r.style.display="none",n.style.display="block")})},display:function(){w.fill(0,0,0),w.textSize(50),w.textAlign("center","top"),w.text("Create an account",w.width/2,150)},buttons:[new _t({x:65,y:35,width:100,height:50,display:function(){w.stroke(255,255,255),w.strokeWeight(5),this.isInside(We,this)?(w.fill(175,175,175),We.setCursor("pointer")):w.fill(200,200,200,200),w.rect(this.x,this.y,this.width,this.height,10),w.textSize(20),w.textStyle("Arial"),w.fill(0,0,0),w.textAlign("center","bottom"),w.text("Home",this.x+this.width/2,this.y+this.height-15)},onClick:function(){ze.createTransition("menu")}})]};let Ar;const Og={name:"Personal Profile",init:function(){new Pn,new ut(75,window.innerWidth/window.innerHeight,.1,1e3),Ar=new Ln,Ar.setSize(window.innerWidth,window.innerHeight),document.getElementById("threed-canvas").innerHTML="",document.getElementById("threed-canvas").appendChild(Ar.domElement),w.width=window.innerWidth,w.height=window.innerHeight},display:function(){w.fill(0,0,0),w.textSize(50),w.textAlign("center","top"),w.text("Personal Profile",w.width/2,150)},buttons:[new _t({x:65,y:35,width:100,height:50,display:function(){w.stroke(255,255,255),w.strokeWeight(5),this.isInside(We,this)?(w.fill(175,175,175),We.setCursor("pointer")):w.fill(200,200,200,200),w.rect(this.x,this.y,this.width,this.height,10),w.textSize(20),w.textStyle("Arial"),w.fill(0,0,0),w.textAlign("center","bottom"),w.text("Home",this.x+this.width/2,this.y+this.height-15)},onClick:function(){ze.createTransition("menu")}})]};let wr;const Bg={name:"Public Profile Scene",init:function(){new Pn,new ut(75,window.innerWidth/window.innerHeight,.1,1e3),wr=new Ln,wr.setSize(window.innerWidth,window.innerHeight),document.getElementById("threed-canvas").innerHTML="",document.getElementById("threed-canvas").appendChild(wr.domElement),w.width=window.innerWidth,w.height=window.innerHeight},display:function(){w.fill(0,0,0),w.textSize(50),w.textAlign("center","top"),w.text("Public Profile",25,150)},buttons:[new _t({x:65,y:35,width:100,height:50,display:function(){w.stroke(255,255,255),w.strokeWeight(5),this.isInside(We,this)?(w.fill(175,175,175),We.setCursor("pointer")):w.fill(200,200,200,200),w.rect(this.x,this.y,this.width,this.height,10),w.textSize(20),w.textStyle("Arial"),w.fill(0,0,0),w.textAlign("center","bottom"),w.text("Home",this.x+this.width/2,this.y+this.height-15)},onClick:function(){ze.createTransition("menu")}})]};let Rr;const kg={name:"Settings",init:function(){new Pn,new ut(75,window.innerWidth/window.innerHeight,.1,1e3),Rr=new Ln,Rr.setSize(window.innerWidth,window.innerHeight),document.getElementById("threed-canvas").innerHTML="",document.getElementById("threed-canvas").appendChild(Rr.domElement),w.width=window.innerWidth,w.height=window.innerHeight},display:function(){w.fill(0,0,0),w.textSize(50),w.textAlign("center","top"),w.text("Settings",w.width/2,150)},buttons:[new _t({x:65,y:35,width:100,height:50,display:function(){w.stroke(255,255,255),w.strokeWeight(5),this.isInside(We,this)?(w.fill(175,175,175),We.setCursor("pointer")):w.fill(200,200,200,200),w.rect(this.x,this.y,this.width,this.height,10),w.textSize(20),w.textStyle("Arial"),w.fill(0,0,0),w.textAlign("center","bottom"),w.text("Home",this.x+this.width/2,this.y+this.height-15)},onClick:function(){ze.createTransition("menu")}})]};let Cr;const zg={name:"Arena",init:function(){new Pn,new ut(75,window.innerWidth/window.innerHeight,.1,1e3),Cr=new Ln,Cr.setSize(window.innerWidth,window.innerHeight),document.getElementById("threed-canvas").innerHTML="",document.getElementById("threed-canvas").appendChild(Cr.domElement),w.width=window.innerWidth,w.height=window.innerHeight;const i=document.querySelector(".html-content");i.innerHTML=`
    ...
    `;let e,t=async()=>{const r=await(await fetch("/arenas",{method:"GET",headers:{"Content-Type":"application/json"}})).json(),o=document.getElementById("arena-list");o.innerHTML="",r.arenas.forEach(a=>{const c=document.createElement("div");c.classList.add("arena"),c.style.border="1px solid black",c.style.padding="10px",c.style.marginBottom="10px",c.innerHTML=`
          ...
          `,o.appendChild(c)}),document.querySelectorAll(".join-arena-btn").forEach(a=>{a.addEventListener("click",function(){const c=this.getAttribute("data-id");console.log("Joining arena:",c),En.establish_connection(c,()=>{console.log("Arena started by another player..."),clearInterval(e),ze.createTransition("play")})})}),document.querySelectorAll(".start-arena-btn").forEach(a=>{a.addEventListener("click",function(){const c=this.getAttribute("data-id");console.log("Starting Arena: ",c),clearInterval(e),ze.createTransition("play"),En.start_arena(c)})})};t(),e=setInterval(t,5e3),document.getElementById("create-arena-btn").addEventListener("click",function(){n()}),document.getElementById("arena-create-form").addEventListener("submit",async function(s){s.preventDefault();const r=document.getElementById("arena-name").value;try{const a=await(await fetch("/create-arena",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:r})})).json();a.error?alert("Error: "+a.error):(alert("Arena created!"),t())}catch(o){console.error("Failed to create arena:",o)}}),document.getElementById("cancel-create-arena").addEventListener("click",function(){document.getElementById("create-arena").style.display="none"});function n(){document.getElementById("create-arena").style.display="block"}},display:function(){w.fill(0,0,0),w.textSize(50),w.textAlign("center","top"),w.text("Arena",w.width/2,150)},buttons:[new _t({x:65,y:35,width:100,height:50,display:function(){w.stroke(255,255,255),w.strokeWeight(5),this.isInside(We,this)?(w.fill(175,175,175),We.setCursor("pointer")):w.fill(200,200,200,200),w.rect(this.x,this.y,this.width,this.height,10),w.textSize(20),w.textStyle("Arial"),w.fill(0,0,0),w.textAlign("center","bottom"),w.text("Home",this.x+this.width/2,this.y+this.height-15)},onClick:function(){ze.createTransition("menu")}})]};ft.register("W","KeyW");ft.register("A","KeyA");ft.register("S","KeyS");ft.register("D","KeyD");ft.register("UP","ArrowUp");ft.register("DOWN","ArrowDown");ft.register("LEFT","ArrowLeft");ft.register("RIGHT","ArrowRight");ft.register("Space","Space");ft.register("Shift","ShiftLeft");ft.register("Ctrl","ControlLeft");ft.register("C","KeyC");ft.register("LeftMouseButton",0);_t.registerType("rect",oh);_t.registerType("circle",ah);ze.addScene("menu",Ug);ze.addScene("login",Ng);ze.addScene("signup",Fg);ze.addScene("personal-profile",Og);ze.addScene("public-profile",Bg);ze.addScene("settings",kg);ze.addScene("play",Dg);ze.addScene("arenas",zg);let tc=0;function Vo(i){const e=(i-tc)/1e3;tc=i,ln.getContext("2d").clearRect(0,0,ln.width,ln.height),We.setCursor("default"),ze.displayScene(e),Fr.runIntervals(e),requestAnimationFrame(Vo)}(async()=>{const i=await fetch("/authenticated-user").then(e=>e.json()).then(e=>e.error?null:e.user).catch(e=>console.error("AJAX request failed:",e));ze.user=i,ze.setScene("menu"),requestAnimationFrame(Vo),ft.handleEvents(),We.handleEvents()})();const Jc=document.getElementById("ui-canvas");Jc.width=window.innerWidth;Jc.height=window.innerHeight;window.onload=function(){Vo()};
